...
procedure TCustomScrollBar_Init(const Params: PParamArray);cdecl;
begin
...
procedure TCustomScrollBar_SetParams(const Params: PParamArray);cdecl;
begin
  PCustomScrollBar(Params^[0])^.SetParams(PInteger(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^, PInteger(Params^[4])^);
end;

//procedure SetParams(APosition, AMin, AMax: Integer);
procedure TCustomScrollBar_SetParamsEx(const Params: PParamArray);cdecl;
begin
...
procedure TCustomScrollBar_Kind_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PScrollBarKind(Result)^ := PCustomScrollBar(Params^[0])^.Kind;
end;

//Write: property Kind: TScrollBarKind read Kind write Kind;
procedure TCustomScrollBar_Kind_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomScrollBar_LargeChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomScrollBar_SmallChange_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomScrollBar_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomScrollBar_OnChange_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomScrollBar_OnScroll_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomScrollBar_OnScroll_Write(const Params: PParamArray);cdecl;
begin
  PCustomScrollBar(Params^[0])^.OnScroll := PScrollEvent(Params^[1])^;
end;

//procedure Free();
procedure TCustomScrollBar_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TScrollBar_Init(const Params: PParamArray);cdecl;
begin
  PScrollBar(Params^[0])^ := TScrollBar.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TScrollBar_Free(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_Init(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^ := TCustomComboBox.Create(PComponent(Params^[1])^);
end;

//procedure IntfGetItems;
procedure TCustomComboBox_IntfGetItems(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.IntfGetItems();
end;

//procedure AddItem(const Item: String; AnObject: TObject);
procedure TCustomComboBox_AddItem(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_AddHistoryItem(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_AddHistoryItemEx(const Params: PParamArray);cdecl;
begin
...
//procedure Clear;
procedure TCustomComboBox_Clear(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.Clear();
end;

//procedure ClearSelection;
procedure TCustomComboBox_ClearSelection(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.ClearSelection();
end;

//Read: property DroppedDown: Boolean read DroppedDown write DroppedDown;
procedure TCustomComboBox_DroppedDown_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_DroppedDown_Write(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.DroppedDown := PBoolean(Params^[1])^;
end;

//procedure SelectAll;
procedure TCustomComboBox_SelectAll(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.SelectAll();
end;

//Read: property AutoComplete: boolean read AutoComplete write AutoComplete;
procedure TCustomComboBox_AutoComplete_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_AutoComplete_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_AutoDropDown_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_AutoDropDown_Write(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.AutoDropDown := PBoolean(Params^[1])^;
end;

//Read: property AutoSelect: Boolean read AutoSelect write AutoSelect;
procedure TCustomComboBox_AutoSelect_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomComboBox(Params^[0])^.AutoSelect;
end;

//Write: property AutoSelect: Boolean read AutoSelect write AutoSelect;
procedure TCustomComboBox_AutoSelect_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_AutoSelected_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_AutoSelected_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomComboBox_ArrowKeysTraverseList_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_ArrowKeysTraverseList_Write(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.ArrowKeysTraverseList := PBoolean(Params^[1])^;
end;

//Read: property Canvas: TCanvas read FCanvas;
procedure TCustomComboBox_Canvas_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_DropDownCount_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_Style_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomComboBox_Style_Write(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.Style := PComboBoxStyle(Params^[1])^;
end;

//Read: property Text: string read Text write Text;
procedure TCustomComboBox_Text_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PCustomComboBox(Params^[0])^.Text;
end;

//Write: property Text: string read Text write Text;
procedure TCustomComboBox_Text_Write(const Params: PParamArray);cdecl;
begin
  PCustomComboBox(Params^[0])^.Text := PlpString(Params^[1])^;
end;

//procedure Free();
procedure TCustomComboBox_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TComboBox_Init(const Params: PParamArray);cdecl;
begin
  PComboBox(Params^[0])^ := TComboBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TComboBox_Free(const Params: PParamArray);cdecl;
begin
...
{TListBox}
//constructor Create(TheOwner: TComponent);
procedure TCustomListBox_Init(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^ := TCustomListBox.Create(PComponent(Params^[1])^);
end;

//procedure AddItem(const Item: String; AnObject: TObject);
procedure TCustomListBox_AddItem(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.AddItem(PlpString(Params^[1])^, PObject(Params^[2])^);
end;

//procedure Click;
procedure TCustomListBox_Click(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.Click();
end;

//procedure Clear;
procedure TCustomListBox_Clear(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.Clear();
end;

//procedure ClearSelection;
procedure TCustomListBox_ClearSelection(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.ClearSelection();
end;

//function GetIndexAtXY(X, Y: integer): integer;
procedure TCustomListBox_GetIndexAtXY(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomListBox_GetIndexAtY(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomListBox(Params^[0])^.GetIndexAtY(Pinteger(Params^[1])^);
end;

//function GetSelectedText: string;
procedure TCustomListBox_GetSelectedText(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PCustomListBox(Params^[0])^.GetSelectedText();
end;

//function ItemAtPos(const Pos: TPoint; Existing: Boolean): Integer;
procedure TCustomListBox_ItemAtPos(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PCustomListBox(Params^[0])^.ItemAtPos(PPoint(Params^[1])^, PBoolean(Params^[2])^);
end;

//function ItemRect(Index: Integer): TRect;
procedure TCustomListBox_ItemRect(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PCustomListBox(Params^[0])^.ItemRect(PInteger(Params^[1])^);
end;

//function ItemVisible(Index: Integer): boolean;
procedure TCustomListBox_ItemVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomListBox(Params^[0])^.ItemVisible(PInteger(Params^[1])^);
end;

//function ItemFullyVisible(Index: Integer): boolean;
procedure TCustomListBox_ItemFullyVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomListBox(Params^[0])^.ItemFullyVisible(PInteger(Params^[1])^);
end;

//procedure LockSelectionChange;
procedure TCustomListBox_LockSelectionChange(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.LockSelectionChange();
end;

//procedure MakeCurrentVisible;
procedure TCustomListBox_MakeCurrentVisible(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.MakeCurrentVisible();
end;

//procedure MeasureItem(Index: Integer; var TheHeight: Integer); virtual;
procedure TCustomListBox_MeasureItem(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.MeasureItem(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure SelectAll; virtual;
procedure TCustomListBox_SelectAll(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.SelectAll();
end;

//procedure UnlockSelectionChange;
procedure TCustomListBox_UnlockSelectionChange(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.UnlockSelectionChange();
end;

//Read: property Canvas: TCanvas read FCanvas;
procedure TCustomListBox_Canvas_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomListBox_ClickOnSelChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomListBox_ClickOnSelChange_Write(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.ClickOnSelChange := Pboolean(Params^[1])^;
end;

//Read: property Columns: Integer read Columns write Columns ;
procedure TCustomListBox_Columns_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PCustomListBox(Params^[0])^.Columns;
end;

//Write: property Columns: Integer read Columns write Columns ;
procedure TCustomListBox_Columns_Write(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.Columns := PInteger(Params^[1])^;
end;

//Read: property Count: Integer read Count;
procedure TCustomListBox_Count_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomListBox_ExtendedSelect_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomListBox_ExtendedSelect_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomListBox_ItemHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PCustomListBox(Params^[0])^.ItemHeight;
end;

//Write: property ItemHeight: Integer read ItemHeight write ItemHeight;
procedure TCustomListBox_ItemHeight_Write(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.ItemHeight := PInteger(Params^[1])^;
end;

//Read: property ItemIndex: integer read ItemIndex write ItemIndex;
procedure TCustomListBox_ItemIndex_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomListBox(Params^[0])^.ItemIndex;
end;

//Write: property ItemIndex: integer read ItemIndex write ItemIndex;
procedure TCustomListBox_ItemIndex_Write(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.ItemIndex := Pinteger(Params^[1])^;
end;

//Read: property Items: TStrings read Items write Items;
procedure TCustomListBox_Items_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PStrings(Result)^ := PCustomListBox(Params^[0])^.Items;
end;

//Write: property Items: TStrings read Items write Items;
procedure TCustomListBox_Items_Write(const Params: PParamArray);cdecl;
begin
  PCustomListBox(Params^[0])^.Items := PStrings(Params^[1])^;
end;

//Read: property MultiSelect: boolean read MultiSelect write MultiSelect;
procedure TCustomListBox_MultiSelect_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomListBox(Params^[0])^.MultiSelect;
end;

//Write: property MultiSelect: boolean read MultiSelect write MultiSelect;
procedure TCustomListBox_MultiSelect_Write(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TListBox_Init(const Params: PParamArray);cdecl;
begin
  PListBox(Params^[0])^ := TListBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TListBox_Free(const Params: PParamArray);cdecl;
begin
...
{TEdit}
//constructor Create(AOwner: TComponent);
procedure TCustomEdit_Init(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^ := TCustomEdit.Create(PComponent(Params^[1])^);
end;

//procedure Clear;
procedure TCustomEdit_Clear(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.Clear();
end;

//procedure SelectAll;
procedure TCustomEdit_SelectAll(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.SelectAll();
end;

//procedure ClearSelection;
procedure TCustomEdit_ClearSelection(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.ClearSelection();
end;

//procedure CopyToClipboard;
procedure TCustomEdit_CopyToClipboard(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.CopyToClipboard();
end;

//procedure CutToClipboard;
procedure TCustomEdit_CutToClipboard(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.CutToClipboard();
end;

//procedure PasteFromClipboard;
procedure TCustomEdit_PasteFromClipboard(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.PasteFromClipboard();
end;

//procedure Undo;
procedure TCustomEdit_Undo(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.Undo();
end;

//Read: property CanUndo: Boolean read CanUndo;
procedure TCustomEdit_CanUndo_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomEdit(Params^[0])^.CanUndo;
end;

//Read: property CaretPos: TPoint read CaretPos write CaretPos;
procedure TCustomEdit_CaretPos_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PPoint(Result)^ := PCustomEdit(Params^[0])^.CaretPos;
end;

//Write: property CaretPos: TPoint read CaretPos write CaretPos;
procedure TCustomEdit_CaretPos_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.CaretPos := PPoint(Params^[1])^;
end;

//Read: property HideSelection: Boolean read HideSelection write HideSelection;
procedure TCustomEdit_HideSelection_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomEdit_HideSelection_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.HideSelection := PBoolean(Params^[1])^;
end;

//Read: property MaxLength: Integer read MaxLength write MaxLength;
procedure TCustomEdit_MaxLength_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PCustomEdit(Params^[0])^.MaxLength;
end;

//Write: property MaxLength: Integer read MaxLength write MaxLength;
procedure TCustomEdit_MaxLength_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.MaxLength := PInteger(Params^[1])^;
end;

//Read: property Modified: Boolean read Modified write Modified;
procedure TCustomEdit_Modified_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomEdit(Params^[0])^.Modified;
end;

//Write: property Modified: Boolean read Modified write Modified;
procedure TCustomEdit_Modified_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.Modified := PBoolean(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TCustomEdit_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PCustomEdit(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TCustomEdit_OnChange_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//Read: property PasswordChar: Char read PasswordChar write PasswordChar;
procedure TCustomEdit_PasswordChar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PChar(Result)^ := PCustomEdit(Params^[0])^.PasswordChar;
end;

//Write: property PasswordChar: Char read PasswordChar write PasswordChar;
procedure TCustomEdit_PasswordChar_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.PasswordChar := PChar(Params^[1])^;
end;

//Read: property ReadOnly: Boolean read ReadOnly write ReadOnly;
procedure TCustomEdit_ReadOnly_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomEdit(Params^[0])^.ReadOnly;
end;

//Write: property ReadOnly: Boolean read ReadOnly write ReadOnly;
procedure TCustomEdit_ReadOnly_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.ReadOnly := PBoolean(Params^[1])^;
end;

//Read: property SelLength: integer read SelLength write SelLength;
procedure TCustomEdit_SelLength_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomEdit(Params^[0])^.SelLength;
end;

//Write: property SelLength: integer read SelLength write SelLength;
procedure TCustomEdit_SelLength_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.SelLength := Pinteger(Params^[1])^;
end;

//Read: property SelStart: integer read SelStart write SelStart;
procedure TCustomEdit_SelStart_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomEdit(Params^[0])^.SelStart;
end;

//Write: property SelStart: integer read SelStart write SelStart;
procedure TCustomEdit_SelStart_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.SelStart := Pinteger(Params^[1])^;
end;

//Read: property SelText: String read SelText write SelText;
procedure TCustomEdit_SelText_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PCustomEdit(Params^[0])^.SelText;
end;

//Write: property SelText: String read SelText write SelText;
procedure TCustomEdit_SelText_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.SelText := PlpString(Params^[1])^;
end;

//Read: property Text: string read Text write Text;
procedure TCustomEdit_Text_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PCustomEdit(Params^[0])^.Text;
end;

//Write: property Text: string read Text write Text;
procedure TCustomEdit_Text_Write(const Params: PParamArray);cdecl;
begin
  PCustomEdit(Params^[0])^.Text := PlpString(Params^[1])^;
end;

//procedure Free();
procedure TCustomEdit_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TEdit_Init(const Params: PParamArray);cdecl;
begin
  PEdit(Params^[0])^ := TEdit.Create(PComponent(Params^[1])^);
end;

procedure TEdit_OnEditingDone_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PEdit(Params^[0])^.OnEditingDone;
end;

procedure TEdit_OnEditingDone_Write(const Params: PParamArray);cdecl;
begin
  PEdit(Params^[0])^.OnEditingDone := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TEdit_Free(const Params: PParamArray);cdecl;
begin
  PEdit(Params^[0])^.Free();
end;
...
procedure TCustomGroupBox_Init(const Params: PParamArray);cdecl;
begin
  PCustomGroupBox(Params^[0])^ := TCustomGroupBox.Create(PComponent(Params^[1])^);
end;

procedure TCustomGroupBox_Free(const Params: PParamArray);cdecl;
begin
...
procedure TGroupBox_Init(const Params: PParamArray);cdecl;
begin
  PGroupBox(Params^[0])^ := TGroupBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TGroupBox_Free(const Params: PParamArray);cdecl;
begin
...
{TMemo}
//constructor Create(AOwner: TComponent);
procedure TMemoScrollbar_Init(const Params: PParamArray);cdecl;
begin
  PMemoScrollbar(Params^[0])^ := TMemoScrollbar.Create(PWinControl(Params^[1])^, PScrollBarKind(Params^[2])^);
end;

//procedure Free();
procedure TMemoScrollbar_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TCustomMemo_Init(const Params: PParamArray);cdecl;
begin
  PCustomMemo(Params^[0])^ := TCustomMemo.Create(PComponent(Params^[1])^);
end;

//procedure Append(const Value: String);
procedure TCustomMemo_Append(const Params: PParamArray);cdecl;
begin
  PCustomMemo(Params^[0])^.Append(PlpString(Params^[1])^);
end;

//Read: property Lines: TStrings read Lines write Lines;
procedure TCustomMemo_Lines_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PStrings(Result)^ := PCustomMemo(Params^[0])^.Lines;
end;

//Write: property Lines: TStrings read Lines write Lines;
procedure TCustomMemo_Lines_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomMemo_HorzScrollBar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomMemo_HorzScrollBar_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomMemo_VertScrollBar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomMemo_VertScrollBar_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomMemo_ScrollBars_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomMemo_ScrollBars_Write(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TMemo_Init(const Params: PParamArray);cdecl;
begin
  PMemo(Params^[0])^ := TMemo.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TMemo_Free(const Params: PParamArray);cdecl;
begin
  PMemo(Params^[0])^.Free();
end;
...
{TStaticText}
//constructor Create(AOwner: TComponent);
procedure TCustomStaticText_Init(const Params: PParamArray);cdecl;
begin
...
procedure TCustomStaticText_Alignment_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PAlignment(Result)^ := PCustomStaticText(Params^[0])^.Alignment;
end;

//Write: property Alignment: TAlignment read Alignment write Alignment;
procedure TCustomStaticText_Alignment_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomStaticText_BorderStyle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomStaticText_BorderStyle_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomStaticText_FocusControl_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomStaticText_FocusControl_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomStaticText_ShowAccelChar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomStaticText_ShowAccelChar_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomStaticText_Transparent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomStaticText_Transparent_Write(const Params: PParamArray);cdecl;
begin
  PCustomStaticText(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

//procedure Free();
procedure TCustomStaticText_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TStaticText_Init(const Params: PParamArray);cdecl;
begin
  PStaticText(Params^[0])^ := TStaticText.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TStaticText_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TButtonControl_Init(const Params: PParamArray);cdecl;
begin
  PButtonControl(Params^[0])^ := TButtonControl.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TButtonControl_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TButton_Init(const Params: PParamArray);cdecl;
begin
  PButton(Params^[0])^ := TButton.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TButton_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TCustomCheckBox_Init(const Params: PParamArray);cdecl;
begin
...
procedure TCustomCheckBox_AllowGrayed_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomCheckBox_AllowGrayed_Write(const Params: PParamArray);cdecl;
begin
  PCustomCheckBox(Params^[0])^.AllowGrayed := PBoolean(Params^[1])^;
end;

//Read: property State: TCheckBoxState read State write State;
procedure TCustomCheckBox_State_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PCheckBoxState(Result)^ := PCustomCheckBox(Params^[0])^.State;
end;

//Write: property State: TCheckBoxState read State write State;
procedure TCustomCheckBox_State_Write(const Params: PParamArray);cdecl;
begin
  PCustomCheckBox(Params^[0])^.State := PCheckBoxState(Params^[1])^;
end;

//Read: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TCustomCheckBox_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PCustomCheckBox(Params^[0])^.OnChange;
end;

//Write: property OnChange: TNotifyEvent read OnChange write OnChange;
procedure TCustomCheckBox_OnChange_Write(const Params: PParamArray);cdecl;
begin
  PCustomCheckBox(Params^[0])^.OnChange := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TCustomCheckBox_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TCheckBox_Init(const Params: PParamArray);cdecl;
begin
  PCheckBox(Params^[0])^ := TCheckBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCheckBox_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TCustomLabel_Init(const Params: PParamArray);cdecl;
begin
  PCustomLabel(Params^[0])^ := TCustomLabel.Create(PComponent(Params^[1])^);
end;

//function ColorIsStored: boolean;
procedure TCustomLabel_ColorIsStored(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomLabel(Params^[0])^.ColorIsStored();
end;

//function AdjustFontForOptimalFill: Boolean;
procedure TCustomLabel_AdjustFontForOptimalFill(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomLabel(Params^[0])^.AdjustFontForOptimalFill();
end;

//procedure Paint;
procedure TCustomLabel_Paint(const Params: PParamArray);cdecl;
begin
  PCustomLabel(Params^[0])^.Paint();
end;

//procedure SetBounds(aLeft, aTop, aWidth, aHeight: integer);
procedure TCustomLabel_SetBounds(const Params: PParamArray);cdecl;
begin
  PCustomLabel(Params^[0])^.SetBounds(Pinteger(Params^[1])^, Pinteger(Params^[2])^, Pinteger(Params^[3])^, Pinteger(Params^[4])^);
end;

//procedure Free();
procedure TCustomLabel_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(TheOwner: TComponent);
procedure TLabel_Init(const Params: PParamArray);cdecl;
begin
  PLabel(Params^[0])^ := TLabel.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TLabel_Free(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_FindDownButton(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_LoadGlyphFromLazarusResource(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_AllowAllUp_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_AllowAllUp_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_GroupIndex_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_GroupIndex_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_Layout_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_Layout_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_Margin_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomSpeedButton(Params^[0])^.Margin;
end;

//Write: property Margin: integer read FMargin write SetMargin default -1;
procedure TCustomSpeedButton_Margin_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_NumGlyphs_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_NumGlyphs_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_ShowAccelChar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_ShowAccelChar_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_ShowCaption_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_ShowCaption_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_Spacing_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_Spacing_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpeedButton_Transparent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpeedButton_Transparent_Write(const Params: PParamArray);cdecl;
begin
  PCustomSpeedButton(Params^[0])^.Transparent := PBoolean(Params^[1])^;
end;

//constructor Create();
procedure TCustomSpeedButton_Init(const Params: PParamArray);cdecl;
begin
  PCustomSpeedButton(Params^[0])^ := TCustomSpeedButton.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomSpeedButton_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TSpeedButton_Init(const Params: PParamArray);cdecl;
begin
  PSpeedButton(Params^[0])^ := TSpeedButton.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TSpeedButton_Free(const Params: PParamArray);cdecl;
begin
