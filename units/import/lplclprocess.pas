...
procedure TOutputPipeStream_Seek(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pint64(Result)^ := POutputPipeStream(Params^[0])^.Seek(Pint64(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//Function Read (Var Buffer; Count : Longint) : longint; Override;
procedure TOutputPipeStream_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Plongint(Result)^ := POutputPipeStream(Params^[0])^.Read(PLongint(Params^[1])^, PLongint(Params^[2])^);
end;

//constructor Create();
procedure TOutputPipeStream_Init(const Params: PParamArray);cdecl;
begin
  POutputPipeStream(Params^[0])^ := TOutputPipeStream.Create(PHandle(Params^[1])^);
end;

//procedure Free();
procedure TOutputPipeStream_Free(const Params: PParamArray);cdecl;
begin
...
procedure TInputPipeStream_Write(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLongint(Result)^ := PInputPipeStream(Params^[0])^.Write(PLongint(Params^[1])^, PLongint(Params^[2])^);
end;

//function Seek(const Offset: int64; Origin: TSeekOrigin): int64; override;
procedure TInputPipeStream_Seek(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pint64(Result)^ := PInputPipeStream(Params^[0])^.Seek(Pint64(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//Function Read (Var Buffer; Count : Longint) : longint; Override;
procedure TInputPipeStream_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TInputPipeStream_NumBytesAvailable_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PDWord(Result)^ := PInputPipeStream(Params^[0])^.NumBytesAvailable;
end;

//constructor Create();
procedure TInputPipeStream_Init(const Params: PParamArray);cdecl;
begin
  PInputPipeStream(Params^[0])^ := TInputPipeStream.Create(PHandle(Params^[1])^);
end;

//procedure Free();
procedure TInputPipeStream_Free(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_Execute(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.Execute();
end;

//procedure CloseInput; virtual;
procedure TProcess_CloseInput(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.CloseInput();
end;

//procedure CloseOutput; virtual;
procedure TProcess_CloseOutput(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.CloseOutput();
end;

//procedure CloseStderr; virtual;
procedure TProcess_CloseStderr(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.CloseStderr();
end;

//Function Resume : Integer; virtual;
procedure TProcess_Resume(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PProcess(Params^[0])^.Resume();
end;

//Function Suspend : Integer; virtual;
procedure TProcess_Suspend(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PProcess(Params^[0])^.Suspend();
end;

//Function Terminate (AExitCode : Integer): Boolean; virtual;
procedure TProcess_Terminate(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PProcess(Params^[0])^.Terminate(PInteger(Params^[1])^);
end;

//Function WaitOnExit : Boolean;
procedure TProcess_WaitOnExit(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PProcess(Params^[0])^.WaitOnExit();
end;

//Read: Property Handle : THandle Read FProcessHandle;
procedure TProcess_Handle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PHandle(Result)^ := PProcess(Params^[0])^.Handle;
end;

//Read: Property ProcessHandle : THandle Read FProcessHandle;
procedure TProcess_ProcessHandle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PHandle(Result)^ := PProcess(Params^[0])^.ProcessHandle;
end;

//Read: Property ThreadHandle : THandle Read FThreadHandle;
procedure TProcess_ThreadHandle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PHandle(Result)^ := PProcess(Params^[0])^.ThreadHandle;
end;

//Read: Property ProcessID : Integer Read FProcessID;
procedure TProcess_ProcessID_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PProcess(Params^[0])^.ProcessID;
end;

//Read: Property ThreadID : Integer Read FThreadID;
procedure TProcess_ThreadID_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PProcess(Params^[0])^.ThreadID;
end;

//Read: Property ExitStatus : Integer Read GetExitStatus;
procedure TProcess_ExitStatus_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_InheritHandles_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_InheritHandles_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_PipeBufferSize_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_PipeBufferSize_Write(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.PipeBufferSize := Pcardinal(Params^[1])^;
end;

//Read: Property Active : Boolean Read GetRunning Write SetActive;
procedure TProcess_Active_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PProcess(Params^[0])^.Active;
end;

//Write: Property Active : Boolean Read GetRunning Write SetActive;
procedure TProcess_Active_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_ApplicationName_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_ApplicationName_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_CommandLine_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_CurrentDirectory_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_Options_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_Options_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_Priority_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_Priority_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_StartupOptions_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_StartupOptions_Write(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.StartupOptions := PStartupOptions(Params^[1])^;
end;

//Read: Property Running : Boolean Read GetRunning;
procedure TProcess_Running_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_ShowWindow_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_ShowWindow_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_WindowColumns_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_FillAttribute_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TProcess_FillAttribute_Write(const Params: PParamArray);cdecl;
begin
...
procedure TProcess_XTermProgram_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PProcess(Params^[0])^.XTermProgram;
end;

//Write: Property XTermProgram : String Read FXTermProgram Write FXTermProgram;
procedure TProcess_XTermProgram_Write(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.XTermProgram := PlpString(Params^[1])^;
end;

//constructor Create();
procedure TProcess_Init(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^ := TProcess.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TProcess_Free(const Params: PParamArray);cdecl;
begin
  PProcess(Params^[0])^.Free();
end;

//Read: Property Input  : TOutputPipeStream Read FInputStream;
procedure TProcess_Input_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  POutputPipeStream(Result)^ := PProcess(Params^[0])^.Input;
end;

//Read: Property Output : TInputPipeStream  Read FOutputStream;
procedure TProcess_Output_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInputPipeStream(Result)^ := PProcess(Params^[0])^.Output;
end;

//Read: Property Stderr : TinputPipeStream  Read FStderrStream;
procedure TProcess_Stderr_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
