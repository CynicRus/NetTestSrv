...
uses
  Classes, SysUtils, Forms, controls, lpcompiler, lptypes, ulpClassHelper;
...
procedure TSizeConstraints_Init(const Params: PParamArray);cdecl;
begin
  PSizeConstraints(Params^[0])^ := TSizeConstraints.Create(PControl(Params^[1])^);
end;

//procedure UpdateInterfaceConstraints; virtual;
procedure TSizeConstraints_UpdateInterfaceConstraints(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_SetInterfaceConstraints(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_EffectiveMinWidth(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.EffectiveMinWidth();
end;

//function EffectiveMinHeight: integer; virtual;
procedure TSizeConstraints_EffectiveMinHeight(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.EffectiveMinHeight();
end;

//function EffectiveMaxWidth: integer; virtual;
procedure TSizeConstraints_EffectiveMaxWidth(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.EffectiveMaxWidth();
end;

//function EffectiveMaxHeight: integer; virtual;
procedure TSizeConstraints_EffectiveMaxHeight(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.EffectiveMaxHeight();
end;

//function MinMaxWidth(Width: integer): integer;
procedure TSizeConstraints_MinMaxWidth(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.MinMaxWidth(Pinteger(Params^[1])^);
end;

//function MinMaxHeight(Height: integer): integer;
procedure TSizeConstraints_MinMaxHeight(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MaxInterfaceHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MaxInterfaceWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MinInterfaceHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MinInterfaceWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PSizeConstraints(Params^[0])^.MinInterfaceWidth;
end;

//Read: property Control: TControl read FControl;
procedure TSizeConstraints_Control_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_Options_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_Options_Write(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_OnChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_OnChange_Write(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_MaxHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MaxHeight_Write(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_MaxWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MaxWidth_Write(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_MinHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MinHeight_Write(const Params: PParamArray);cdecl;
begin
...
procedure TSizeConstraints_MinWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TSizeConstraints_MinWidth_Write(const Params: PParamArray);cdecl;
begin
  PSizeConstraints(Params^[0])^.MinWidth := PConstraintSize(Params^[1])^;
end;

//procedure Free();
procedure TSizeConstraints_Free(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_Init(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^ := TCustomForm.Create(PComponent(Params^[1])^);
end;

//constructor CreateNew(AOwner: TComponent; Num: Integer);
procedure TCustomForm_CreateNew(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^ := TCustomForm.CreateNew(PComponent(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure AfterConstruction;
procedure TCustomForm_AfterConstruction(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.AfterConstruction();
end;

//procedure BeforeDestruction;
procedure TCustomForm_BeforeDestruction(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.BeforeDestruction();
end;

//procedure Close;
procedure TCustomForm_Close(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.Close();
end;

//function CloseQuery: boolean;
procedure TCustomForm_CloseQuery(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomForm(Params^[0])^.CloseQuery();
end;

//procedure DefocusControl(Control: TWinControl; Removing: Boolean);
procedure TCustomForm_DefocusControl(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.DefocusControl(PWinControl(Params^[1])^, PBoolean(Params^[2])^);
end;

//procedure DestroyWnd;
procedure TCustomForm_DestroyWnd(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.DestroyWnd();
end;

//procedure EnsureVisible(AMoveToTop: Boolean);
procedure TCustomForm_EnsureVisible(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.EnsureVisible(PBoolean(Params^[1])^);
end;

//procedure FocusControl(WinControl: TWinControl);
procedure TCustomForm_FocusControl(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.FocusControl(PWinControl(Params^[1])^);
end;

//function FormIsUpdating: boolean;
procedure TCustomForm_FormIsUpdating(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCustomForm(Params^[0])^.FormIsUpdating();
end;

//function GetFormImage: TBitmap;
procedure TCustomForm_GetFormImage(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBitmap(Result)^ := PCustomForm(Params^[0])^.GetFormImage();
end;

//procedure Hide;
procedure TCustomForm_Hide(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.Hide();
end;

//procedure IntfDropFiles(const FileNames: TStringArray);
procedure TCustomForm_IntfDropFiles(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.IntfDropFiles(PStringArray(Params^[1])^);
end;

//procedure IntfHelp(AComponent: TComponent);
procedure TCustomForm_IntfHelp(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.IntfHelp(PComponent(Params^[1])^);
end;

//function AutoSizeDelayedHandle: Boolean;
procedure TCustomForm_AutoSizeDelayedHandle(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_GetPreferredSize(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.GetPreferredSize(Pinteger(Params^[1])^, Pinteger(Params^[2])^, Pboolean(Params^[3])^, Pboolean(Params^[4])^);
end;

//procedure Release;
procedure TCustomForm_Release(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.Release();
end;

//function CanFocus: Boolean;
procedure TCustomForm_CanFocus(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomForm(Params^[0])^.CanFocus();
end;

//procedure SetFocus;
procedure TCustomForm_SetFocus(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.SetFocus();
end;

//function SetFocusedControl(Control: TWinControl): Boolean ;
procedure TCustomForm_SetFocusedControl(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_SetRestoredBounds(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.SetRestoredBounds(Pinteger(Params^[1])^, Pinteger(Params^[2])^, Pinteger(Params^[3])^, Pinteger(Params^[4])^);
end;

//procedure Show;
procedure TCustomForm_Show(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.Show();
end;

//function ShowModal: Integer;
procedure TCustomForm_ShowModal(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PCustomForm(Params^[0])^.ShowModal();
end;

//procedure ShowOnTop;
procedure TCustomForm_ShowOnTop(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.ShowOnTop();
end;

//procedure RemoveAllHandlersOfObject(AnObject: TObject);
procedure TCustomForm_RemoveAllHandlersOfObject(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_AddHandlerFirstShow(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_RemoveHandlerFirstShow(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_AddHandlerClose(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_RemoveHandlerClose(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_AddHandlerCreate(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_RemoveHandlerCreate(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.RemoveHandlerCreate(PNotifyEvent(Params^[1])^);
end;

//Read: property Active: Boolean read Active;
procedure TCustomForm_Active_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_ActiveControl_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_ActiveControl_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_ActiveDefaultControl_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_ActiveDefaultControl_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_AllowDropFiles_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_AllowDropFiles_Write(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.AllowDropFiles := PBoolean(Params^[1])^;
end;

//Read: property AlphaBlend: Boolean read AlphaBlend write AlphaBlend;
procedure TCustomForm_AlphaBlend_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomForm(Params^[0])^.AlphaBlend;
end;

//Write: property AlphaBlend: Boolean read AlphaBlend write AlphaBlend;
procedure TCustomForm_AlphaBlend_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_AlphaBlendValue_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_AlphaBlendValue_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_CancelControl_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_CancelControl_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_DefaultControl_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_DefaultControl_Write(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.DefaultControl := PControl(Params^[1])^;
end;

//Read: property KeyPreview: Boolean read KeyPreview write KeyPreview;
procedure TCustomForm_KeyPreview_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PCustomForm(Params^[0])^.KeyPreview;
end;

//Write: property KeyPreview: Boolean read KeyPreview write KeyPreview;
procedure TCustomForm_KeyPreview_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_PopupParent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_PopupParent_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_OnActivate_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_OnCloseQuery_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_OnCloseQuery_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_OnCreate_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PCustomForm(Params^[0])^.OnCreate;
end;

//Write: property OnCreate: TNotifyEvent read OnCreate write OnCreate;
procedure TCustomForm_OnCreate_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_OnDeactivate_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_OnDeactivate_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_OnShow_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PCustomForm(Params^[0])^.OnShow;
end;

//Write: property OnShow: TNotifyEvent read FOnShow write FOnShow;
procedure TCustomForm_OnShow_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_OnWindowStateChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_OnWindowStateChange_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomForm_PixelsPerInch_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomForm_PixelsPerInch_Write(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.PixelsPerInch := PLongint(Params^[1])^;
end;

//Read: property RestoredLeft: integer read RestoredLeft;
procedure TCustomForm_RestoredLeft_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomForm(Params^[0])^.RestoredLeft;
end;

//Read: property RestoredTop: integer read RestoredTop;
procedure TCustomForm_RestoredTop_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomForm(Params^[0])^.RestoredTop;
end;

//Read: property RestoredWidth: integer read RestoredWidth;
procedure TCustomForm_RestoredWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomForm(Params^[0])^.RestoredWidth;
end;

//Read: property RestoredHeight: integer read RestoredHeight;
procedure TCustomForm_RestoredHeight_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomForm(Params^[0])^.RestoredHeight;
end;

procedure TCustomForm_Write_BorderStyle(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.BorderStyle := PFormBorderStyle(Params^[1])^;
end;

procedure TCustomForm_Read_BorderStyle(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PFormBorderStyle(Result)^ := PCustomForm(Params^[0])^.BorderStyle;
end;

procedure TCustomForm_Write_BorderIcons(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.BorderIcons := PFormBorderIcons(Params^[1])^;
end;

procedure TCustomForm_Read_BorderIcons(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PFormBorderIcons(Result)^ := PCustomForm(Params^[0])^.BorderIcons;
end;

procedure TCustomForm_Constraints_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PSizeConstraints(Result)^ := PCustomForm(Params^[0])^.Constraints;
end;

procedure TCustomForm_Constraints_Write(const Params: PParamArray);cdecl;
begin
  PCustomForm(Params^[0])^.Constraints := PSizeConstraints(Params^[1])^;
end;

//procedure Free();
procedure TCustomForm_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TScrollBox_Init(const Params: PParamArray);cdecl;
begin
  PScrollBox(Params^[0])^ := TScrollBox.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TScrollBox_Free(const Params: PParamArray);cdecl;
begin
