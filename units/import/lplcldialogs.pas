...
procedure TLCLComponent_RemoveAllHandlersOfObject(const Params: PParamArray);cdecl;
begin
  PLCLComponent(Params^[0])^.RemoveAllHandlersOfObject(PObject(Params^[1])^);
end;

//procedure IncLCLRefCount;
procedure TLCLComponent_IncLCLRefCount(const Params: PParamArray);cdecl;
begin
  PLCLComponent(Params^[0])^.IncLCLRefCount();
end;

//procedure DecLCLRefCount;
procedure TLCLComponent_DecLCLRefCount(const Params: PParamArray);cdecl;
begin
  PLCLComponent(Params^[0])^.DecLCLRefCount();
end;

//Read: property LCLRefCount: integer read FLCLRefCount;
procedure TLCLComponent_LCLRefCount_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PLCLComponent(Params^[0])^.LCLRefCount;
end;

//constructor Create();
procedure TLCLComponent_Init(const Params: PParamArray);cdecl;
begin
 PLCLComponent(Params^[0])^ := TLCLComponent.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TLCLComponent_Free(const Params: PParamArray);cdecl;
begin
...
Procedure TCommonDialog_FCompStyle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLongInt(Result)^ := PCommonDialog(Params^[0])^.FCompStyle;
end;

//Write: FCompStyle : LongInt;
procedure TCommonDialog_FCompStyle_Write(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.FCompStyle := PLongInt(Params^[1])^;
end;

//function Execute: boolean; virtual;
procedure TCommonDialog_Execute(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCommonDialog(Params^[0])^.Execute();
end;

//Read: property Handle: THandle read FHandle write SetHandle;
procedure TCommonDialog_Handle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PHandle(Result)^ := PCommonDialog(Params^[0])^.Handle;
end;

//Write: property Handle: THandle read FHandle write SetHandle;
procedure TCommonDialog_Handle_Write(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.Handle := PHandle(Params^[1])^;
end;

//Read: property UserChoice: integer read FUserChoice write FUserChoice;
procedure TCommonDialog_UserChoice_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCommonDialog(Params^[0])^.UserChoice;
end;

//Write: property UserChoice: integer read FUserChoice write FUserChoice;
procedure TCommonDialog_UserChoice_Write(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.UserChoice := Pinteger(Params^[1])^;
end;

//procedure Close; virtual;
procedure TCommonDialog_Close(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.Close();
End;

//procedure DoShow; virtual;
procedure TCommonDialog_DoShow(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.DoShow();
end;

//procedure DoCanClose(var CanClose: Boolean); virtual;
procedure TCommonDialog_DoCanClose(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.DoCanClose(PBoolean(Params^[1])^);
end;

//procedure DoClose; virtual;
procedure TCommonDialog_DoClose(const Params: PParamArray);cdecl;
begin
  PCommonDialog(Params^[0])^.DoClose();
end;

//function HandleAllocated: boolean;
procedure TCommonDialog_HandleAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PCommonDialog(Params^[0])^.HandleAllocated();
end;

//Read: property OnClose: TNotifyEvent read FOnClose write FOnClose;
procedure TCommonDialog_OnClose_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PCommonDialog(Params^[0])^.OnClose;
end;

//Write: property OnClose: TNotifyEvent read FOnClose write FOnClose;
procedure TCommonDialog_OnClose_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCommonDialog_OnCanClose_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TFileDialog_DoTypeChange(const Params: PParamArray);cdecl;
begin
  PFileDialog(Params^[0])^.DoTypeChange();
end;

//function Execute: boolean; override;
procedure TFileDialog_Execute(const Params: PParamArray; const Result: Pointer);cdecl;
Begin
  Pboolean(Result)^ := PFileDialog(Params^[0])^.Execute();
end;

//Read: property Files: TStrings read FFiles;
procedure TFileDialog_Files_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PStrings(Result)^ := PFileDialog(Params^[0])^.Files;
end;

//Read: property HistoryList: TStrings read FHistoryList write SetHistoryList;
procedure TFileDialog_HistoryList_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TFileDialog_HistoryList_Write(const Params: PParamArray);cdecl;
begin
  PFileDialog(Params^[0])^.HistoryList := PStrings(Params^[1])^;
end;

//procedure IntfFileTypeChanged(NewFilterIndex: Integer);
procedure TFileDialog_IntfFileTypeChanged(const Params: PParamArray);cdecl;
begin
...
procedure TFileDialog_FilterIndex_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TFileDialog_OnHelpClicked_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TFileDialog_OnHelpClicked_Write(const Params: PParamArray);cdecl;
begin
...
procedure TFileDialog_OnTypeChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TFileDialog_OnTypeChange_Write(const Params: PParamArray);cdecl;
begin
  PFileDialog(Params^[0])^.OnTypeChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TFileDialog_Init(const Params: PParamArray);cdecl;
begin
  PFileDialog(Params^[0])^ := TFileDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TFileDialog_Free(const Params: PParamArray);cdecl;
begin
...
procedure TOpenDialog_DoFolderChange(const Params: PParamArray);cdecl;
begin
  POpenDialog(Params^[0])^.DoFolderChange();
end;

//procedure DoSelectionChange; virtual;
procedure TOpenDialog_DoSelectionChange(const Params: PParamArray);cdecl;
begin
  POpenDialog(Params^[0])^.DoSelectionChange();
end;

//procedure IntfSetOption(const AOption: TOpenOption; const AValue: Boolean);
procedure TOpenDialog_IntfSetOption(const Params: PParamArray);cdecl;
begin
...
procedure TOpenDialog_Options_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TOpenDialog_Options_Write(const Params: PParamArray);cdecl;
begin
...
procedure TOpenDialog_OnFolderChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
Begin
...
procedure TOpenDialog_OnFolderChange_Write(const Params: PParamArray);cdecl;
begin
...
procedure TOpenDialog_OnSelectionChange_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TOpenDialog_OnSelectionChange_Write(const Params: PParamArray);cdecl;
begin
  POpenDialog(Params^[0])^.OnSelectionChange := PNotifyEvent(Params^[1])^;
end;

//constructor Create();
procedure TOpenDialog_Init(const Params: PParamArray);cdecl;
begin
  POpenDialog(Params^[0])^ := TOpenDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TOpenDialog_Free(const Params: PParamArray);cdecl;
begin
...
procedure TColorDialog_Color_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PColor(Result)^ := PColorDialog(Params^[0])^.Color;
end;

//Write: property Color: TColor read FColor write FColor;
procedure TColorDialog_Color_Write(const Params: PParamArray);cdecl;
begin
  PColorDialog(Params^[0])^.Color := PColor(Params^[1])^;
end;

//Read: property CustomColors: TStrings read FCustomColors write SetCustomColors;
procedure TColorDialog_CustomColors_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TColorDialog_CustomColors_Write(const Params: PParamArray);cdecl;
begin
  PColorDialog(Params^[0])^.CustomColors := PStrings(Params^[1])^;
end;

//constructor Create();
procedure TColorDialog_Init(const Params: PParamArray);cdecl;
begin
  PColorDialog(Params^[0])^ := TColorDialog.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TColorDialog_Free(const Params: PParamArray);cdecl;
begin
