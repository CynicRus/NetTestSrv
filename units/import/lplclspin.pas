...
procedure TCustomFloatSpinEdit_GetLimitedValue(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomFloatSpinEdit_ValueToStr(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomFloatSpinEdit_StrToValue(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomFloatSpinEdit_DecimalPlaces_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomFloatSpinEdit_DecimalPlaces_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomFloatSpinEdit_ValueEmpty_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomFloatSpinEdit_ValueEmpty_Write(const Params: PParamArray);cdecl;
begin
  PCustomFloatSpinEdit(Params^[0])^.ValueEmpty := PBoolean(Params^[1])^;
end;

//constructor Create();
procedure TCustomFloatSpinEdit_Init(const Params: PParamArray);cdecl;
begin
  PCustomFloatSpinEdit(Params^[0])^ := TCustomFloatSpinEdit.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomFloatSpinEdit_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TFloatSpinEdit_Init(const Params: PParamArray);cdecl;
begin
  PFloatSpinEdit(Params^[0])^ := TFloatSpinEdit.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TFloatSpinEdit_Free(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpinEdit_Value_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PCustomSpinEdit(Params^[0])^.Value;
end;

//Write: property Value: integer read GetValue write SetValue default 0;
procedure TCustomSpinEdit_Value_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpinEdit_MinValue_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpinEdit_MinValue_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpinEdit_MaxValue_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpinEdit_MaxValue_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomSpinEdit_Increment_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomSpinEdit_Increment_Write(const Params: PParamArray);cdecl;
begin
  PCustomSpinEdit(Params^[0])^.Increment := Pinteger(Params^[1])^;
end;

//constructor Create();
procedure TCustomSpinEdit_Init(const Params: PParamArray);cdecl;
begin
  PCustomSpinEdit(Params^[0])^ := TCustomSpinEdit.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomSpinEdit_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TSpinEdit_Init(const Params: PParamArray);cdecl;
begin
  PSpinEdit(Params^[0])^ := TSpinEdit.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TSpinEdit_Free(const Params: PParamArray);cdecl;
begin
