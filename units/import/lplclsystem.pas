...
procedure TPersistent_Assign(const Params: PParamArray); cdecl;
begin
  PPersistent(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//function  GetNamePath: string;
procedure TPersistent_GetNamePath(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PlpString(Result)^ := PPersistent(Params^[0])^.GetNamePath();
end;

//constructor Create();
procedure TPersistent_Init(const Params: PParamArray); cdecl;
begin
  PPersistent(Params^[0])^ := TPersistent.Create();
end;

//procedure Free();
procedure TPersistent_Free(const Params: PParamArray); cdecl;
begin
...
procedure TStream_WriteResourceHeader(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.WriteResourceHeader(PlpString(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure FixupResourceHeader(FixupInfo: Integer);
procedure TStream_FixupResourceHeader(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.FixupResourceHeader(PInteger(Params^[1])^);
end;

//procedure ReadResHeader;
procedure TStream_ReadResHeader(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.ReadResHeader();
end;

//function ReadByte : Byte;
procedure TStream_ReadByte(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PByte(Result)^ := PStream(Params^[0])^.ReadByte();
end;

//function ReadWord : Word;
procedure TStream_ReadWord(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PWord(Result)^ := PStream(Params^[0])^.ReadWord();
end;

//function ReadDWord : Cardinal;
procedure TStream_ReadDWord(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PCardinal(Result)^ := PStream(Params^[0])^.ReadDWord();
end;

//function ReadAnsiString : String;
procedure TStream_ReadAnsiString(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PlpString(Result)^ := PStream(Params^[0])^.ReadAnsiString();
end;

//procedure WriteByte(b : Byte);
procedure TStream_WriteByte(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.WriteByte(PByte(Params^[1])^);
end;

//procedure WriteWord(w : Word);
procedure TStream_WriteWord(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.WriteWord(PWord(Params^[1])^);
end;

//procedure WriteDWord(d : Cardinal);
procedure TStream_WriteDWord(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.WriteDWord(PCardinal(Params^[1])^);
end;

//Procedure WriteAnsiString (const S : String);
procedure TStream_WriteAnsiString(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.WriteAnsiString(PlpString(Params^[1])^);
end;

//Read: property Position: Int64 read Position write Position;
procedure TStream_Position_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInt64(Result)^ := PStream(Params^[0])^.Position;
end;

//Write: property Position: Int64 read Position write Position;
procedure TStream_Position_Write(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.Position := PInt64(Params^[1])^;
end;

//Read: property Size: Int64 read Size write Size;
procedure TStream_Size_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInt64(Result)^ := PStream(Params^[0])^.Size;
end;

//Write: property Size: Int64 read Size write Size;
procedure TStream_Size_Write(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^.Size := PInt64(Params^[1])^;
end;

//constructor Create();
procedure TStream_Init(const Params: PParamArray); cdecl;
begin
  PStream(Params^[0])^ := TStream.Create();
end;

//procedure Free();
procedure TStream_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TStream.Read(var Buffer; Count: Longint): Longint; constref;', @TStream_Read);
    addGlobalFunc('function TStream.Write(constref Buffer; Count: Longint): Longint; constref;', @TStream_Write); //test
    addGlobalFunc('function TStream.Seek(Offset: Longint; Origin: Word): Longint; constref;', @TStream_Seek);
    addGlobalFunc('procedure TStream.ReadBuffer(var Buffer; Count: Longint); constref;', @TStream_ReadBuffer);
    addGlobalFunc('procedure TStream.WriteBuffer(constref Buffer; Count: Longint); constref;', @TStream_WriteBuffer);
    addGlobalFunc('function TStream.CopyFrom(Source: TStream; Count: Int64): Int64; constref;', @TStream_CopyFrom);
    addGlobalFunc('function TStream.ReadComponent(Instance: TComponent): TComponent; constref;', @TStream_ReadComponent);
    addGlobalFunc('function TStream.ReadComponentRes(Instance: TComponent): TComponent; constref;', @TStream_ReadComponentRes);
    addGlobalFunc('procedure TStream.WriteComponent(Instance: TComponent); constref;', @TStream_WriteComponent);
    addGlobalFunc('procedure TStream.WriteComponentRes(const ResName: string; Instance: TComponent); constref;', @TStream_WriteComponentRes);
    addGlobalFunc('procedure TStream.WriteDescendent(Instance, Ancestor: TComponent); constref;', @TStream_WriteDescendent);
    addGlobalFunc('procedure TStream.WriteDescendentRes(const ResName: string; Instance, Ancestor: TComponent); constref;', @TStream_WriteDescendentRes);
    addGlobalFunc('procedure TStream.WriteResourceHeader(const ResName: string; var FixupInfo: Integer); constref;', @TStream_WriteResourceHeader);
    addGlobalFunc('procedure TStream.FixupResourceHeader(FixupInfo: Integer); constref;', @TStream_FixupResourceHeader);
    addGlobalFunc('procedure TStream.ReadResHeader(); constref;', @TStream_ReadResHeader);
    addGlobalFunc('function TStream.ReadByte(): Byte; constref;', @TStream_ReadByte);
    addGlobalFunc('function TStream.ReadWord(): Word; constref;', @TStream_ReadWord);
    addGlobalFunc('function TStream.ReadDWord(): Cardinal; constref;', @TStream_ReadDWord);
    addGlobalFunc('function TStream.ReadAnsiString(): String; constref;', @TStream_ReadAnsiString);
    addGlobalFunc('procedure TStream.WriteByte(b : Byte); constref;', @TStream_WriteByte);
    addGlobalFunc('procedure TStream.WriteWord(w : Word); constref;', @TStream_WriteWord);
    addGlobalFunc('procedure TStream.WriteDWord(d : Cardinal); constref;', @TStream_WriteDWord);
    addGlobalFunc('procedure TStream.WriteAnsiString(const S : String); constref;', @TStream_WriteAnsiString);
...
procedure THandleStream_Init(const Params: PParamArray); cdecl;
begin
  PHandleStream(Params^[0])^ := THandleStream.Create(PHandle(Params^[1])^);
end;

//function Read(var Buffer: pointer; Count: Longint): Longint;
procedure THandleStream_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure THandleStream_Write(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PLongint(Result)^ := PHandleStream(Params^[0])^.Write(Ppointer(Params^[1])^, PLongint(Params^[2])^);
end;

//function Seek(const Offset: Int64; Origin: TSeekOrigin): Int64;
procedure THandleStream_Seek(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInt64(Result)^ := PHandleStream(Params^[0])^.Seek(PInt64(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//Read: property Handle: Handle read Handle;
procedure THandleStream_Handle_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PHandle(Result)^ := PHandleStream(Params^[0])^.Handle;
end;

//procedure Free();
procedure THandleStream_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function THandleStream.Read(var Buffer; Count: Longint): Longint; constref;', @THandleStream_Read);
...
procedure TFileStream_Init(const Params: PParamArray); cdecl;
begin
  PFileStream(Params^[0])^ := TFileStream.Create(PlpString(Params^[1])^, PWord(Params^[2])^);
end;

//constructor Create(const AFileName: string; Mode: Word; Rights: Cardinal);
procedure TFileStream_InitEx(const Params: PParamArray); cdecl;
begin
...
procedure TFileStream_FileName_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PlpString(Result)^ := PFileStream(Params^[0])^.FileName;
end;

//procedure Free();
procedure TFileStream_Free(const Params: PParamArray); cdecl;
begin
...
//function Read(var Buffer: pointer; Count: LongInt): LongInt;
procedure TCustomMemoryStream_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TCustomMemoryStream_Seek(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInt64(Result)^ := PCustomMemoryStream(Params^[0])^.Seek(PInteger(Params^[1])^, PSeekOrigin(Params^[2])^);
end;

//procedure SaveToStream(Stream: TStream);
procedure TCustomMemoryStream_SaveToStream(const Params: PParamArray); cdecl;
begin
  PCustomMemoryStream(Params^[0])^.SaveToStream(PStream(Params^[1])^);
end;

//procedure SaveToFile(const FileName: string);
procedure TCustomMemoryStream_SaveToFile(const Params: PParamArray); cdecl;
begin
  PCustomMemoryStream(Params^[0])^.SaveToFile(PlpString(Params^[1])^);
end;

//Read: property Memory: Pointer read Memory;
procedure TCustomMemoryStream_Memory_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PPointer(Result)^ := PCustomMemoryStream(Params^[0])^.Memory;
end;

//constructor Create();
procedure TCustomMemoryStream_Init(const Params: PParamArray); cdecl;
begin
  PCustomMemoryStream(Params^[0])^ := TCustomMemoryStream.Create();
end;

//procedure Free();
procedure TCustomMemoryStream_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TCustomMemoryStream.Read(var Buffer; Count: LongInt): LongInt; constref;', @TCustomMemoryStream_Read);
    addGlobalFunc('function TCustomMemoryStream.Seek(const Offset: Integer; Origin: TSeekOrigin): Int64; constref;', @TCustomMemoryStream_Seek);
    addGlobalFunc('procedure TCustomMemoryStream.SaveToStream(Stream: TStream); constref;', @TCustomMemoryStream_SaveToStream);
...
{TMemoryStream}
//procedure Clear;
procedure TMemoryStream_Clear(const Params: PParamArray); cdecl;
begin
  PMemoryStream(Params^[0])^.Clear();
end;

//procedure LoadFromStream(Stream: TStream);
procedure TMemoryStream_LoadFromStream(const Params: PParamArray); cdecl;
begin
  PMemoryStream(Params^[0])^.LoadFromStream(PStream(Params^[1])^);
end;

//procedure LoadFromFile(const FileName: string);
procedure TMemoryStream_LoadFromFile(const Params: PParamArray); cdecl;
begin
  PMemoryStream(Params^[0])^.LoadFromFile(PlpString(Params^[1])^);
end;

//procedure SetSize(NewSize: PtrInt);
procedure TMemoryStream_SetSize(const Params: PParamArray); cdecl;
begin
  PMemoryStream(Params^[0])^.SetSize(PPtrInt(Params^[1])^);
end;

//function Write(const Buffer: pointer; Count: LongInt): LongInt;
procedure TMemoryStream_Write(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PLongInt(Result)^ := PMemoryStream(Params^[0])^.Write(PLongInt(Params^[1])^, PLongInt(Params^[2])^);
end;

//constructor Create();
procedure TMemoryStream_Init(const Params: PParamArray); cdecl;
begin
  PMemoryStream(Params^[0])^ := TMemoryStream.Create();
end;

//procedure Free();
procedure TMemoryStream_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TMemoryStream.Clear(); constref;', @TMemoryStream_Clear);
    addGlobalFunc('procedure TMemoryStream.LoadFromStream(Stream: TStream); constref;', @TMemoryStream_LoadFromStream);
    addGlobalFunc('procedure TMemoryStream.LoadFromFile(const FileName: string); constref;', @TMemoryStream_LoadFromFile);
...
procedure TStringStream_Init(const Params: PParamArray); cdecl;
begin
  PStringStream(Params^[0])^ := TStringStream.Create(PlpString(Params^[1])^);
end;

//function Read(var Buffer: longint; Count: Longint): Longint;
procedure TStringStream_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PLongint(Result)^ := PStringStream(Params^[0])^.Read(Plongint(Params^[1])^, PLongint(Params^[2])^);
end;

//function ReadString(Count: Longint): string;
procedure TStringStream_ReadString(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PlpString(Result)^ := PStringStream(Params^[0])^.ReadString(PLongint(Params^[1])^);
end;

//function Seek(Offset: Longint; Origin: Word): Longint;
procedure TStringStream_Seek(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TStringStream_Write(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PLongint(Result)^ := PStringStream(Params^[0])^.Write(PLongInt(Params^[1])^, PLongint(Params^[2])^);
end;

//procedure WriteString(const AString: string);
procedure TStringStream_WriteString(const Params: PParamArray); cdecl;
begin
  PStringStream(Params^[0])^.WriteString(PlpString(Params^[1])^);
end;

//Read: property DataString: string read FDataString;
procedure TStringStream_DataString_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PlpString(Result)^ := PStringStream(Params^[0])^.DataString;
end;

//procedure Free();
procedure TStringStream_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TStringStream.Read(var Buffer; Count: Longint): Longint; constref;', @TStringStream_Read);
    addGlobalFunc('function TStringStream.ReadString(Count: Longint): string; constref;', @TStringStream_ReadString);
    addGlobalFunc('function TStringStream.Seek(Offset: Longint; Origin: Word): Longint; constref;', @TStringStream_Seek);
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TStrings.AddObject(const S: string; AObject: TObject): Integer; constref;', @TStrings_AddObject);
    addGlobalFunc('procedure TStrings.Append(const S: string); constref;', @TStrings_Append);
    addGlobalFunc('procedure TStrings.AddStrings(const TheStrings: TStrings); constref;', @TStrings_AddStrings);
    addGlobalFunc('procedure TStrings.Assign(Source: TPersistent); constref;', @TStrings_Assign);
    addGlobalFunc('procedure TStrings.BeginUpdate(); constref;', @TStrings_BeginUpdate);
    addGlobalFunc('procedure TStrings.Clear(); constref;', @TStrings_Clear);
    addGlobalFunc('procedure TStrings.Delete(Index: Integer); constref;', @TStrings_Delete);
    addGlobalFunc('procedure TStrings.EndUpdate(); constref;', @TStrings_EndUpdate);
    addGlobalFunc('function TStrings.EqualsObj(Obj: TObject): Boolean; constref;', @TStrings_EqualsObj);
    addGlobalFunc('function TStrings.EqualsStrings(TheStrings: TStrings): Boolean; constref;', @TStrings_EqualsStrings);
    addGlobalFunc('procedure TStrings.Exchange(Index1, Index2: Integer); constref;', @TStrings_Exchange);
    addGlobalFunc('function TStrings.IndexOf(const S: string): Integer; constref;', @TStrings_IndexOf);
    addGlobalFunc('function TStrings.IndexOfName(const Name: string): Integer; constref;', @TStrings_IndexOfName);
    addGlobalFunc('function TStrings.IndexOfObject(AObject: TObject): Integer; constref;', @TStrings_IndexOfObject);
    addGlobalFunc('procedure TStrings.Insert(Index: Integer; const S: string); constref;', @TStrings_Insert);
    addGlobalFunc('procedure TStrings.InsertObject(Index: Integer; const S: string;AObject:Tobject); constref;', @TStrings_InsertObject);
    addGlobalFunc('procedure TStrings.LoadFromFile(const FileName: string); constref;', @TStrings_LoadFromFile);
    addGlobalFunc('procedure TStrings.LoadFromStream(Stream: TStream); constref;', @TStrings_LoadFromStream);
    addGlobalFunc('procedure TStrings.Move(CurIndex, NewIndex: Integer); constref;', @TStrings_Move);
    addGlobalFunc('procedure TStrings.SaveToFile(const FileName: string); constref;', @TStrings_SaveToFile);
    addGlobalFunc('procedure TStrings.SaveToStream(Stream: TStream); constref;', @TStrings_SaveToStream);
...
procedure TStringList_OnChanging_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TStringList_OnChanging_Write(const Params: PParamArray); cdecl;
begin
...
procedure TStringList_OwnsObjects_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  Pboolean(Result)^ := PStringList(Params^[0])^.OwnsObjects;
end;

//Write: property OwnsObjects : boolean read OwnsObjects write OwnsObjects;
procedure TStringList_OwnsObjects_Write(const Params: PParamArray); cdecl;
begin
  PStringList(Params^[0])^.OwnsObjects := Pboolean(Params^[1])^;
end;

//constructor Create();
procedure TStringList_Init(const Params: PParamArray); cdecl;
begin
  PStringList(Params^[0])^ := TStringList.Create();
end;

//procedure Free();
procedure TStringList_Free(const Params: PParamArray); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TStringList.Add(const S: string): Integer; constref;', @TStringList_Add);
    addGlobalFunc('procedure TStringList.Clear(); constref;', @TStringList_Clear);
    addGlobalFunc('procedure TStringList.Delete(Index: Integer); constref;', @TStringList_Delete);
    addGlobalFunc('procedure TStringList.Exchange(Index1, Index2: Integer); constref;', @TStringList_Exchange);
    addGlobalFunc('function TStringList.Find(const S: string; Out Index: Integer): Boolean; constref;', @TStringList_Find);
    addGlobalFunc('function TStringList.IndexOf(const S: string): Integer; constref;', @TStringList_IndexOf);
    addGlobalFunc('procedure TStringList.Insert(Index: Integer; const S: string); constref;', @TStringList_Insert);
    addGlobalFunc('procedure TStringList.Sort(); constref;', @TStringList_Sort);
    addGlobalFunc('procedure TStringList.CustomSort(CompareFn: TStringListSortCompare); constref;', @TStringList_CustomSort);
...
procedure TComponent_Init(const Params: PParamArray); cdecl;
begin
  PComponent(Params^[0])^ := TComponent.Create(PComponent(Params^[1])^);
end;

//procedure DestroyComponents;
procedure TComponent_DestroyComponents(const Params: PParamArray); cdecl;
begin
  PComponent(Params^[0])^.DestroyComponents();
end;

//procedure Destroying;
procedure TComponent_Destroying(const Params: PParamArray); cdecl;
begin
  PComponent(Params^[0])^.Destroying();
end;

//function FindComponent(const AName: string): TComponent;
procedure TComponent_FindComponent(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PComponent(Result)^ := PComponent(Params^[0])^.FindComponent(PlpString(Params^[1])^);
end;

//procedure InsertComponent(AComponent: TComponent);
procedure TComponent_InsertComponent(const Params: PParamArray); cdecl;
begin
  PComponent(Params^[0])^.InsertComponent(PComponent(Params^[1])^);
end;

//procedure RemoveComponent(AComponent: TComponent);
procedure TComponent_RemoveComponent(const Params: PParamArray); cdecl;
begin
...
procedure TComponent_Components(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TComponent_ComponentCount_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TComponent_ComponentIndex_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TComponent_ComponentIndex_Write(const Params: PParamArray); cdecl;
begin
  PComponent(Params^[0])^.ComponentIndex := PInteger(Params^[1])^;
end;

//Read: property ComponentState: TComponentState read FComponentState;
procedure TComponent_ComponentState_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PComponentState(Result)^ := PComponent(Params^[0])^.ComponentState;
end;

//Read: property Owner: TComponent read FOwner;
procedure TComponent_Owner_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TComponent.DestroyComponents(); constref;', @TComponent_DestroyComponents);
    addGlobalFunc('procedure TComponent.Destroying(); constref;', @TComponent_Destroying);
    addGlobalFunc('function TComponent.FindComponent(const AName: string): TComponent; constref;', @TComponent_FindComponent);
    addGlobalFunc('procedure TComponent.InsertComponent(AComponent: TComponent); constref;', @TComponent_InsertComponent);
    addGlobalFunc('procedure TComponent.RemoveComponent(AComponent: TComponent); constref;', @TComponent_RemoveComponent);
    addGlobalFunc('function TComponent.GetComponent(index: integer): TComponent; constref;', @TComponent_Components);
...
procedure TCollectionItem_Init(const Params: PParamArray); cdecl;
begin
  PCollectionItem(Params^[0])^ := TCollectionItem.Create(PCollection(Params^[1])^);
end;

//function GetNamePath: string; override;
procedure TCollectionItem_GetNamePath(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TCollectionItem_Collection_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TCollectionItem_Collection_Write(const Params: PParamArray); cdecl;
begin
  PCollectionItem(Params^[0])^.Collection := PCollection(Params^[1])^;
end;

//Read: property ID: Integer read FID;
procedure TCollectionItem_ID_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInteger(Result)^ := PCollectionItem(Params^[0])^.ID;
end;

//Read: property Index: Integer read GetIndex write SetIndex;
procedure TCollectionItem_Index_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInteger(Result)^ := PCollectionItem(Params^[0])^.Index;
end;

//Write: property Index: Integer read GetIndex write SetIndex;
procedure TCollectionItem_Index_Write(const Params: PParamArray); cdecl;
begin
...
procedure TCollectionItem_DisplayName_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TCollectionItem_DisplayName_Write(const Params: PParamArray); cdecl;
begin
  PCollectionItem(Params^[0])^.DisplayName := PlpString(Params^[1])^;
end;

//procedure Free();
procedure TCollectionItem_Free(const Params: PParamArray); cdecl;
begin
...
procedure TCollection_Owner(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PPersistent(Result)^ := PCollection(Params^[0])^.Owner();
end;

//function Add: TCollectionItem;
procedure TCollection_Add(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PCollectionItem(Result)^ := PCollection(Params^[0])^.Add();
end;

//procedure Assign(Source: TPersistent); override;
procedure TCollection_Assign(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//procedure BeginUpdate; virtual;
procedure TCollection_BeginUpdate(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.BeginUpdate();
end;

//procedure Clear;
procedure TCollection_Clear(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.Clear();
end;

//procedure EndUpdate; virtual;
procedure TCollection_EndUpdate(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.EndUpdate();
end;

//procedure Delete(Index: Integer);
procedure TCollection_Delete(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.Delete(PInteger(Params^[1])^);
end;

//function GetNamePath: string; override;
procedure TCollection_GetNamePath(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PLPString(Result)^ := PCollection(Params^[0])^.GetNamePath();
end;

//function Insert(Index: Integer): TCollectionItem;
procedure TCollection_Insert(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PCollectionItem(Result)^ := PCollection(Params^[0])^.Insert(PInteger(Params^[1])^);
end;

//function FindItemID(ID: Integer): TCollectionItem;
procedure TCollection_FindItemID(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PCollectionItem(Result)^ := PCollection(Params^[0])^.FindItemID(PInteger(Params^[1])^);
end;

//procedure Exchange(Const Index1, index2: integer);
procedure TCollection_Exchange(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.Exchange(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//Read: property Count: Integer read GetCount;
procedure TCollection_Count_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
  PInteger(Result)^ := PCollection(Params^[0])^.Count;
end;

//Read: property Items[Index: Integer]: TCollectionItem read GetItem write SetItem;
procedure TCollection_Items_Index_Read(const Params: PParamArray; const Result: Pointer); cdecl;
begin
...
procedure TCollection_Items_Index_Write(const Params: PParamArray); cdecl;
begin
  PCollection(Params^[0])^.Items[PInteger(Params^[1])^] := PCollectionItem(Params^[2])^;
end;

//procedure Free();
procedure TCollection_Free(const Params: PParamArray); cdecl;
begin
