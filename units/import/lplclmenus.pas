...
procedure TMenuItem_FCompStyle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLongInt(Result)^ := PMenuItem(Params^[0])^.FCompStyle;
end;

//Write: FCompStyle: LongInt;
procedure TMenuItem_FCompStyle_Write(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.FCompStyle := PLongInt(Params^[1])^;
end;

//function Find(const ACaption: string): TMenuItem;
procedure TMenuItem_Find(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenuItem(Result)^ := PMenuItem(Params^[0])^.Find(PlpString(Params^[1])^);
end;

//function GetParentMenu: TMenu; virtual;
procedure TMenuItem_GetParentMenu(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenu(Result)^ := PMenuItem(Params^[0])^.GetParentMenu();
end;

//function GetIsRightToLeft:Boolean; virtual;
procedure TMenuItem_GetIsRightToLeft(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenuItem(Params^[0])^.GetIsRightToLeft();
end;

//function HandleAllocated : Boolean;
procedure TMenuItem_HandleAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenuItem(Params^[0])^.HandleAllocated();
end;

//function HasIcon: boolean; virtual;
procedure TMenuItem_HasIcon(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PMenuItem(Params^[0])^.HasIcon();
end;

//procedure InitiateAction; virtual;
procedure TMenuItem_InitiateAction(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.InitiateAction();
end;

//procedure IntfDoSelect; virtual;
procedure TMenuItem_IntfDoSelect(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.IntfDoSelect();
end;

//function IndexOf(Item: TMenuItem): Integer;
procedure TMenuItem_IndexOf(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_IndexOfCaption(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PMenuItem(Params^[0])^.IndexOfCaption(PlpString(Params^[1])^);
end;

//function VisibleIndexOf(Item: TMenuItem): Integer;
procedure TMenuItem_VisibleIndexOf(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PMenuItem(Params^[0])^.VisibleIndexOf(PMenuItem(Params^[1])^);
end;

//procedure Add(Item: TMenuItem);
procedure TMenuItem_Add(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Add(PMenuItem(Params^[1])^);
end;

//procedure AddSeparator;
procedure TMenuItem_AddSeparator(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.AddSeparator();
end;

//procedure Click; virtual;
procedure TMenuItem_Click(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Click();
end;

//procedure Delete(Index: Integer);
procedure TMenuItem_Delete(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Delete(PInteger(Params^[1])^);
end;

//procedure HandleNeeded; virtual;
procedure TMenuItem_HandleNeeded(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.HandleNeeded();
end;

//procedure Insert(Index: Integer; Item: TMenuItem);
procedure TMenuItem_Insert(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Insert(PInteger(Params^[1])^, PMenuItem(Params^[2])^);
end;

//procedure RecreateHandle; virtual;
procedure TMenuItem_RecreateHandle(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.RecreateHandle();
end;

//procedure Remove(Item: TMenuItem);
procedure TMenuItem_Remove(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Remove(PMenuItem(Params^[1])^);
end;

//function IsCheckItem: boolean; virtual;
procedure TMenuItem_IsCheckItem(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PMenuItem(Params^[0])^.IsCheckItem();
end;

//function IsLine: Boolean;
procedure TMenuItem_IsLine(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenuItem(Params^[0])^.IsLine();
end;

//function IsInMenuBar: boolean; virtual;
procedure TMenuItem_IsInMenuBar(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PMenuItem(Params^[0])^.IsInMenuBar();
end;

//procedure Clear;
procedure TMenuItem_Clear(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Clear();
end;

//function HasBitmap: boolean;
procedure TMenuItem_HasBitmap(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PMenuItem(Params^[0])^.HasBitmap();
end;

//procedure RemoveHandlerOnDestroy(const OnDestroyEvent: TNotifyEvent);
procedure TMenuItem_RemoveHandlerOnDestroy(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.RemoveHandlerOnDestroy(PNotifyEvent(Params^[1])^);
end;

//Read: property Count: Integer read GetCount;
procedure TMenuItem_Count_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PMenuItem(Params^[0])^.Count;
end;

//Read: property Items[Index: Integer]: TMenuItem read GetItem; default;
procedure TMenuItem_Items_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_MenuIndex_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PMenuItem(Params^[0])^.MenuIndex;
end;

//Write: property MenuIndex: Integer read GetMenuIndex write SetMenuIndex;
procedure TMenuItem_MenuIndex_Write(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.MenuIndex := PInteger(Params^[1])^;
end;

//Read: property Menu: TMenu read FMenu;
procedure TMenuItem_Menu_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenu(Result)^ := PMenuItem(Params^[0])^.Menu;
end;

//Read: property Parent: TMenuItem read GetParent;
procedure TMenuItem_Parent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenuItem(Result)^ := PMenuItem(Params^[0])^.Parent;
end;

//Read: property Command: Word read FCommand;
procedure TMenuItem_Command_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PWord(Result)^ := PMenuItem(Params^[0])^.Command;
end;

//function MenuVisibleIndex: integer;
procedure TMenuItem_MenuVisibleIndex(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_AutoCheck_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_Bitmap_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_Hint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_Hint_Write(const Params: PParamArray);cdecl;
begin
...
procedure TMenuItem_RadioItem_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_RadioItem_Write(const Params: PParamArray);cdecl;
begin
...
procedure TMenuItem_RightJustify_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenuItem_RightJustify_Write(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.RightJustify := Pboolean(Params^[1])^;
end;

procedure TMenuItem_OnClick_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PMenuItem(Params^[0])^.OnClick;
end;

procedure TMenuItem_OnClick_Write(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TMenuItem_Init(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^ := TMenuItem.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TMenuItem_Free(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Free();
end;

procedure TMenuItem_Caption_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PMenuItem(Params^[0])^.Caption;
end;

procedure TMenuItem_Caption_Write(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Caption := PTranslateString(Params^[1])^;
end;

procedure TMenuItem_Checked_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenuItem(Params^[0])^.Checked;
end;

procedure TMenuItem_Checked_Write(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Checked := PBoolean(Params^[1])^;
end;

procedure TMenuItem_AddEx(const Params: PParamArray);cdecl;
begin
  PMenuItem(Params^[0])^.Add(PMenuItemArray(Params^[1])^);
end;

procedure TMenuItem_AddMenu(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TMenuItem.Find(const ACaption: string): TMenuItem; constref;', @TMenuItem_Find);
    addGlobalFunc('function TMenuItem.GetParentMenu(): TMenu; constref;', @TMenuItem_GetParentMenu);
    addGlobalFunc('function TMenuItem.GetIsRightToLeft(): Boolean; constref;', @TMenuItem_GetIsRightToLeft);
    addGlobalFunc('function TMenuItem.HandleAllocated(): Boolean; constref;', @TMenuItem_HandleAllocated);
    addGlobalFunc('function TMenuItem.HasIcon(): boolean; constref;', @TMenuItem_HasIcon);
    addGlobalFunc('procedure TMenuItem.InitiateAction(); constref;', @TMenuItem_InitiateAction);
    addGlobalFunc('procedure TMenuItem.IntfDoSelect(); constref;', @TMenuItem_IntfDoSelect);
    addGlobalFunc('function TMenuItem.IndexOf(Item: TMenuItem): Integer; constref;', @TMenuItem_IndexOf);
    addGlobalFunc('function TMenuItem.IndexOfCaption(const ACaption: string): Integer; constref;', @TMenuItem_IndexOfCaption);
    addGlobalFunc('function TMenuItem.VisibleIndexOf(Item: TMenuItem): Integer; constref;', @TMenuItem_VisibleIndexOf);
    addGlobalFunc('procedure TMenuItem.Add(Item: TMenuItem); constref;', @TMenuItem_Add);
    addGlobalFunc('procedure TMenuItem.AddEx(Items: array of TMenuItem); constref;', @TMenuItem_AddEx);
    addGlobalFunc('procedure TMenuItem.AddSeparator(); constref;', @TMenuItem_AddSeparator);
    addGlobalFunc('procedure TMenuItem.Click(); constref;', @TMenuItem_Click);
    addGlobalFunc('procedure TMenuItem.Delete(Index: Integer); constref;', @TMenuItem_Delete);
    addGlobalFunc('procedure TMenuItem.HandleNeeded(); constref;', @TMenuItem_HandleNeeded);
    addGlobalFunc('procedure TMenuItem.Insert(Index: Integer; Item: TMenuItem); constref;', @TMenuItem_Insert);
    addGlobalFunc('procedure TMenuItem.RecreateHandle(); constref;', @TMenuItem_RecreateHandle);
    addGlobalFunc('procedure TMenuItem.Remove(Item: TMenuItem); constref;', @TMenuItem_Remove);
    addGlobalFunc('function TMenuItem.IsCheckItem(): boolean; constref;', @TMenuItem_IsCheckItem);
    addGlobalFunc('function TMenuItem.IsLine(): Boolean; constref;', @TMenuItem_IsLine);
...
//Read: FCompStyle: LongInt;
procedure TMenu_FCompStyle_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLongInt(Result)^ := PMenu(Params^[0])^.FCompStyle;
end;

//Write: FCompStyle: LongInt;
procedure TMenu_FCompStyle_Write(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^.FCompStyle := PLongInt(Params^[1])^;
end;

//procedure DestroyHandle; virtual;
procedure TMenu_DestroyHandle(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^.DestroyHandle();
end;

//function HandleAllocated: Boolean;
procedure TMenu_HandleAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenu(Params^[0])^.HandleAllocated();
end;

//function IsRightToLeft: Boolean; virtual;
procedure TMenu_IsRightToLeft(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenu(Params^[0])^.IsRightToLeft();
end;

//function UseRightToLeftAlignment: Boolean; virtual;
procedure TMenu_UseRightToLeftAlignment(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenu(Params^[0])^.UseRightToLeftAlignment();
end;

//function UseRightToLeftReading: Boolean; virtual;
procedure TMenu_UseRightToLeftReading(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PMenu(Params^[0])^.UseRightToLeftReading();
end;

//procedure HandleNeeded;
procedure TMenu_HandleNeeded(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^.HandleNeeded();
end;

//function DispatchCommand(ACommand: Word): Boolean;
procedure TMenu_DispatchCommand(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenu_Parent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PComponent(Result)^ := PMenu(Params^[0])^.Parent;
end;

//Write: property Parent: TComponent read FParent write SetParent;
procedure TMenu_Parent_Write(const Params: PParamArray);cdecl;
begin
...
procedure TMenu_ShortcutHandled_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenu_ShortcutHandled_Write(const Params: PParamArray);cdecl;
begin
...
procedure TMenu_ParentBidiMode_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TMenu_ParentBidiMode_Write(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^.ParentBidiMode := PBoolean(Params^[1])^;
end;

//Read: property Items: TMenuItem read FItems;
procedure TMenu_Items_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenuItem(Result)^ := PMenu(Params^[0])^.Items;
end;

//constructor Create();
procedure TMenu_Init(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^ := TMenu.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TMenu_Free(const Params: PParamArray);cdecl;
begin
  PMenu(Params^[0])^.Free();
end;

procedure TMenu_AddMenu(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMenuItem(Result)^ := TMenuItem.Create(PMenu(Params^[0])^);
  PMenuItem(Result)^.Caption := PLPString(Params^[1])^;
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TMenu.DestroyHandle(); constref;', @TMenu_DestroyHandle);
    addGlobalFunc('function TMenu.HandleAllocated(): Boolean; constref;', @TMenu_HandleAllocated);
    addGlobalFunc('function TMenu.IsRightToLeft(): Boolean; constref;', @TMenu_IsRightToLeft);
    addGlobalFunc('function TMenu.UseRightToLeftAlignment(): Boolean; constref;', @TMenu_UseRightToLeftAlignment);
    addGlobalFunc('function TMenu.UseRightToLeftReading(): Boolean; constref;', @TMenu_UseRightToLeftReading);
    addGlobalFunc('procedure TMenu.HandleNeeded(); constref;', @TMenu_HandleNeeded);
    addGlobalFunc('function TMenu.DispatchCommand(ACommand: Word): Boolean; constref;', @TMenu_DispatchCommand);
    addGlobalFunc('function TMenu.AddMenu(name: string): TMenuItem; constref;', @TMenu_AddMenu);
...
//constructor Create();
procedure TMainMenu_Init(const Params: PParamArray);cdecl;
begin
  PMainMenu(Params^[0])^ := TMainMenu.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TMainMenu_Free(const Params: PParamArray);cdecl;
begin
