...
uses
  Classes, SysUtils,uxml, lpcompiler, lptypes, ulpClassHelper;
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TXmlNode.Find(Name: String): TXmlNode;  overload;', @TXmlNode_Find);
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TXMLNodeList.Add(aXMLNode: TXMLNode);  overload;', @TXMLNodeList_Add);
    addGlobalFunc('procedure TXMLNodeList.Add(aXMLNodes: TXMLNodeList);  overload;', @TXMLNodeList_AddEx);
    addGlobalFunc('function TXMLNodeList.IndexOf(aXMLNode: TXMLNode): Integer;  overload;', @TXMLNodeList_IndexOf);
    addGlobalFunc('function TXMLNodeList.IndexOf(NodeName: string): Integer;  overload;', @TXMLNodeList_IndexOfEx);
    addGlobalFunc('procedure TXMLNodeList.Delete(aXMLNode: TXMLNode);  overload;', @TXMLNodeList_Delete);
