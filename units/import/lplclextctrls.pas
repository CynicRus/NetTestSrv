...
procedure TCustomTimer_OnStartTimer_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomTimer_OnStartTimer_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomTimer_OnStopTimer_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomTimer_OnStopTimer_Write(const Params: PParamArray);cdecl;
begin
  PCustomTimer(Params^[0])^.OnStopTimer := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TCustomTimer_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TTimer_Init(const Params: PParamArray);cdecl;
begin
  PTimer(Params^[0])^ := TTimer.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TTimer_Free(const Params: PParamArray);cdecl;
begin
...
procedure TCustomImage_Proportional_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomImage_Proportional_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomImage_OnPictureChanged_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomImage_OnPictureChanged_Write(const Params: PParamArray);cdecl;
begin
  PCustomImage(Params^[0])^.OnPictureChanged := PNotifyEvent(Params^[1])^;
end;

//procedure Free();
procedure TCustomImage_Free(const Params: PParamArray);cdecl;
begin
  PCustomImage(Params^[0])^.Free;
end;

procedure TCustomImage_OnMouseDown_Write(const Params: PParamArray);cdecl;
begin
  PCustomImage(Params^[0])^.OnMouseDown := PMouseEvent(Params^[1])^;;
end;

procedure TCustomImage_OnMouseUp_Write(const Params: PParamArray);cdecl;
begin
...
//constructor Create(AOwner: TComponent);
procedure TImage_Init(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^ := TImage.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TImage_Free(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^.Free();
end;

procedure TImage_ShowHint_Write(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^.ShowHint := PBoolean(Params^[1])^;
end;

procedure TImage_ShowHint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
 PBoolean(Result)^ := PImage(Params^[0])^.ShowHint;
end;

procedure TImage_Hint_Write(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^.Hint := PLPString(Params^[1])^;
end;

procedure TImage_Hint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLPString(Result)^ := PImage(Params^[0])^.Hint;
end;

procedure TImage_OnMouseEnter_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PImage(Params^[0])^.OnMouseEnter;
end;

procedure TImage_OnMouseEnter_Write(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^.OnMouseEnter := PNotifyEvent(Params^[1])^;
end;

procedure TImage_OnMouseLeave_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PImage(Params^[0])^.OnMouseLeave;
end;

procedure TImage_OnMouseLeave_Write(const Params: PParamArray);cdecl;
begin
  PImage(Params^[0])^.OnMouseLeave := PNotifyEvent(Params^[1])^;
end;

procedure TImage_OnMouseMove_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PMouseMoveEvent(Result)^ := PImage(Params^[0])^.OnMouseMove;
end;

procedure TImage_OnMouseMove_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomPanel_Alignment_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomPanel_Alignment_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomPanel_BevelInner_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomPanel_BevelInner_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomPanel_BevelOuter_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomPanel_BevelOuter_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomPanel_BevelWidth_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomPanel_BevelWidth_Write(const Params: PParamArray);cdecl;
begin
...
procedure TCustomPanel_FullRepaint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TCustomPanel_FullRepaint_Write(const Params: PParamArray);cdecl;
begin
  PCustomPanel(Params^[0])^.FullRepaint := PBoolean(Params^[1])^;
end;

//constructor Create();
procedure TCustomPanel_Init(const Params: PParamArray);cdecl;
begin
  PCustomPanel(Params^[0])^ := TCustomPanel.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TCustomPanel_Free(const Params: PParamArray);cdecl;
begin
...
//constructor Create();
procedure TPanel_Init(const Params: PParamArray);cdecl;
begin
  PPanel(Params^[0])^ := TPanel.Create(PComponent(Params^[1])^);
end;

//procedure Free();
procedure TPanel_Free(const Params: PParamArray);cdecl;
begin
