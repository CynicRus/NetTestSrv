...
uses
  Classes, SysUtils,Controls, lpcompiler, lptypes, ulpClassHelper;
...
procedure TControl_AdjustSize(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.AdjustSize();
end;

//function AutoSizeDelayed: boolean;
procedure TControl_AutoSizeDelayed(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.AutoSizeDelayed();
end;

//function AutoSizeDelayedReport: string;
procedure TControl_AutoSizeDelayedReport(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PControl(Params^[0])^.AutoSizeDelayedReport();
end;

//function AutoSizeDelayedHandle: Boolean;
procedure TControl_AutoSizeDelayedHandle(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.AutoSizeDelayedHandle();
end;

//procedure SetBounds(aLeft, aTop, aWidth, aHeight: integer);
procedure TControl_SetBounds(const Params: PParamArray);cdecl;
begin
...
procedure TControl_SetInitialBounds(const Params: PParamArray);cdecl;
begin
...
procedure TControl_SetBoundsKeepBase(const Params: PParamArray);cdecl;
begin
...
procedure TControl_GetPreferredSize(const Params: PParamArray);cdecl;
begin
...
procedure TControl_GetDefaultWidth(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PControl(Params^[0])^.GetDefaultWidth();
end;

//function GetDefaultHeight: integer;
procedure TControl_GetDefaultHeight(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PControl(Params^[0])^.GetDefaultHeight();
end;

//function GetColorResolvingParent: Integer;
procedure TControl_GetColorResolvingParent(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetColorResolvingParent();
end;

//function GetRGBColorResolvingParent: Integer;
procedure TControl_GetRGBColorResolvingParent(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetRGBColorResolvingParent();
end;

//procedure InvalidatePreferredSize;
procedure TControl_InvalidatePreferredSize(const Params: PParamArray);cdecl;
begin
...
procedure TControl_UpdateBaseBounds(const Params: PParamArray);cdecl;
begin
...
procedure TControl_BaseBounds_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PControl(Params^[0])^.BaseBounds;
end;

//Read: property ReadBounds: TRect read ReadBounds;
procedure TControl_ReadBounds_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PControl(Params^[0])^.ReadBounds;
end;

//procedure WriteLayoutDebugReport(const Prefix: string);
procedure TControl_WriteLayoutDebugReport(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.WriteLayoutDebugReport(PlpString(Params^[1])^);
end;

//constructor Create(TheOwner: TComponent);
procedure TControl_Init(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^ := TControl.Create(PComponent(Params^[1])^);
end;

//procedure BeforeDestruction;
procedure TControl_BeforeDestruction(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.BeforeDestruction();
end;

//procedure EditingDone;
procedure TControl_EditingDone(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.EditingDone();
end;

//procedure ExecuteDefaultAction;
procedure TControl_ExecuteDefaultAction(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.ExecuteDefaultAction();
end;

//procedure ExecuteCancelAction;
procedure TControl_ExecuteCancelAction(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.ExecuteCancelAction();
end;

//procedure BringToFront;
procedure TControl_BringToFront(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.BringToFront();
end;

//function HasParent: Boolean;
procedure TControl_HasParent(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.HasParent();
end;

//function GetParentComponent: TComponent;
procedure TControl_GetParentComponent(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PComponent(Result)^ := PControl(Params^[0])^.GetParentComponent();
end;

//function IsParentOf(AControl: TControl): boolean;
procedure TControl_IsParentOf(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.IsParentOf(PControl(Params^[1])^);
end;

//function GetTopParent: TControl;
procedure TControl_GetTopParent(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PControl(Result)^ := PControl(Params^[0])^.GetTopParent();
end;

//function IsVisible: Boolean;
procedure TControl_IsVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsVisible();
end;

//function IsControlVisible: Boolean;
procedure TControl_IsControlVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsControlVisible();
end;

//function IsEnabled: Boolean;
procedure TControl_IsEnabled(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsEnabled();
end;

//function IsParentColor: Boolean;
procedure TControl_IsParentColor(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsParentColor();
end;

//function IsParentFont: Boolean;
procedure TControl_IsParentFont(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsParentFont();
end;

//function FormIsUpdating: boolean;
procedure TControl_FormIsUpdating(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.FormIsUpdating();
end;

//function IsProcessingPaintMsg: boolean;
procedure TControl_IsProcessingPaintMsg(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.IsProcessingPaintMsg();
end;

//procedure Hide;
procedure TControl_Hide(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Hide();
end;

//procedure Refresh;
procedure TControl_Refresh(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Refresh();
end;

//procedure Repaint;
procedure TControl_Repaint(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Repaint();
end;

//procedure Invalidate;
procedure TControl_Invalidate(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Invalidate();
end;

//procedure SendToBack;
procedure TControl_SendToBack(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.SendToBack();
end;

//procedure UpdateRolesForForm;
procedure TControl_UpdateRolesForForm(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.UpdateRolesForForm();
end;

//procedure ActiveDefaultControlChanged(NewControl: TControl);
procedure TControl_ActiveDefaultControlChanged(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.ActiveDefaultControlChanged(PControl(Params^[1])^);
end;

//function  GetTextBuf(Buffer: PChar; BufSize: Integer): Integer;
procedure TControl_GetTextBuf(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetTextBuf(PPChar(Params^[1])^, PInteger(Params^[2])^);
end;

//function  GetTextLen: Integer;
procedure TControl_GetTextLen(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.GetTextLen();
end;

//procedure SetTextBuf(Buffer: PChar);
procedure TControl_SetTextBuf(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.SetTextBuf(PPChar(Params^[1])^);
end;

//function  ScreenToClient(const APoint: TPoint): TPoint;
procedure TControl_ScreenToClient(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PPoint(Result)^ := PControl(Params^[0])^.ScreenToClient(PPoint(Params^[1])^);
end;

//function  ClientToScreen(const APoint: TPoint): TPoint;
procedure TControl_ClientToScreen(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PPoint(Result)^ := PControl(Params^[0])^.ClientToScreen(PPoint(Params^[1])^);
end;

//function  ScreenToControl(const APoint: TPoint): TPoint;
procedure TControl_ScreenToControl(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PPoint(Result)^ := PControl(Params^[0])^.ScreenToControl(PPoint(Params^[1])^);
end;

//function  ControlToScreen(const APoint: TPoint): TPoint;
procedure TControl_ControlToScreen(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PPoint(Result)^ := PControl(Params^[0])^.ControlToScreen(PPoint(Params^[1])^);
end;

//function GetChildsRect(Scrolled: boolean): TRect;
procedure TControl_GetChildsRect(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PControl(Params^[0])^.GetChildrenRect(Pboolean(Params^[1])^);
end;

//procedure Show;
procedure TControl_Show(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Show();
end;

//procedure Update;
procedure TControl_Update(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Update();
end;

//function HandleObjectShouldBeVisible: boolean;
procedure TControl_HandleObjectShouldBeVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.HandleObjectShouldBeVisible();
end;

//function ParentDestroyingHandle: boolean;
procedure TControl_ParentDestroyingHandle(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.ParentDestroyingHandle();
end;

//function ParentHandlesAllocated: boolean;
procedure TControl_ParentHandlesAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PControl(Params^[0])^.ParentHandlesAllocated();
end;

//procedure InitiateAction;
procedure TControl_InitiateAction(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.InitiateAction();
end;

//Read: property AutoSize: Boolean read FAutoSize write SetAutoSize default False;
procedure TControl_AutoSize_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.AutoSize;
end;

//Write: property AutoSize: Boolean read FAutoSize write SetAutoSize default False;
procedure TControl_AutoSize_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.AutoSize := PBoolean(Params^[1])^;
end;

//Read: property BoundsRect: TRect read BoundsRect write BoundsRect;
procedure TControl_BoundsRect_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PControl(Params^[0])^.BoundsRect;
end;

//Write: property BoundsRect: TRect read BoundsRect write BoundsRect;
procedure TControl_BoundsRect_Write(const Params: PParamArray);cdecl;
begin
...
procedure TControl_BoundsRectForNewParent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TControl_OnChangeBounds_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TControl_OnChangeBounds_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.OnChangeBounds := PNotifyEvent(Params^[1])^;
end;

procedure TControl_OnClick_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PControl(Params^[0])^.OnClick;
end;

procedure TControl_OnClick_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.OnClick := PNotifyEvent(Params^[1])^;
end;

//Read: property OnResize: TNotifyEvent read OnResize write OnResize;
procedure TControl_OnResize_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PNotifyEvent(Result)^ := PControl(Params^[0])^.OnResize;
end;

//Write: property OnResize: TNotifyEvent read OnResize write OnResize;
procedure TControl_OnResize_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.OnResize := PNotifyEvent(Params^[1])^;
end;

procedure TControl_Align_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PAlign(Result)^ := PControl(Params^[0])^.Align;
end;

procedure TControl_Align_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Align := PAlign(Params^[1])^;
end;

//Read: property Visible: Boolean read Visible write Visible;
procedure TControl_Visible_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.Visible;
end;

//Write: property Visible: Boolean read Visible write Visible;
procedure TControl_Visible_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Visible := PBoolean(Params^[1])^;
end;

//function UseRightToLeftAlignment: Boolean;
procedure TControl_UseRightToLeftAlignment(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftAlignment();
end;

//function UseRightToLeftReading: Boolean;
procedure TControl_UseRightToLeftReading(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftReading();
end;

//function UseRightToLeftScrollBar: Boolean;
procedure TControl_UseRightToLeftScrollBar(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.UseRightToLeftScrollBar();
end;

//function IsRightToLeft: Boolean;
procedure TControl_IsRightToLeft(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.IsRightToLeft();
end;

//Read: property Left: Integer read Left write Left;
procedure TControl_Left_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.Left;
end;

//Write: property Left: Integer read Left write Left;
procedure TControl_Left_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Left := PInteger(Params^[1])^;
end;

//Read: property Height: Integer read Height write Height;
procedure TControl_Height_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.Height;
end;

//Write: property Height: Integer read Height write Height;
procedure TControl_Height_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Height := PInteger(Params^[1])^;
end;

//Read: property Top: Integer read Top write Top;
procedure TControl_Top_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.Top;
end;

//Write: property Top: Integer read Top write Top;
procedure TControl_Top_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Top := PInteger(Params^[1])^;
end;

//Read: property Width: Integer read Width write Width;
procedure TControl_Width_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControl(Params^[0])^.Width;
end;

//Write: property Width: Integer read Width write Width;
procedure TControl_Width_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Width := PInteger(Params^[1])^;
end;

// Procedure ShowHint();
procedure TControl_ShowHint(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.ShowHint := true;
end;

//Read: property Parent: TWinControl;
procedure TControl_Parent_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PWinControl(Result)^ := PControl(Params^[0])^.Parent;
end;

//Write: property Parent: TWinControl;
procedure TControl_Parent_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Parent := PWinControl(Params^[1])^;
end;

procedure TControl_Hint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PLPString(Result)^ := PControl(Params^[0])^.Hint;
end;

procedure TControl_Hint_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Hint := PLPString(Params^[1])^;
end;

procedure TControl_ShowHint_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControl(Params^[0])^.ShowHint;
end;

procedure TControl_ShowHint_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.ShowHint := PBoolean(Params^[1])^;
end;

procedure TControl_Cursor_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PCursor(Result)^ := PControl(Params^[0])^.Cursor;
end;

procedure TControl_Cursor_Write(const Params: PParamArray);cdecl;
begin
  PControl(Params^[0])^.Cursor := PCursor(Params^[1])^;
end;

//procedure Free();
procedure TControl_Free(const Params: PParamArray);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TControl.AdjustSize(); constref;', @TControl_AdjustSize);
    addGlobalFunc('function TControl.AutoSizeDelayed(): boolean; constref;', @TControl_AutoSizeDelayed);
    addGlobalFunc('function TControl.AutoSizeDelayedReport(): string; constref;', @TControl_AutoSizeDelayedReport);
    addGlobalFunc('function TControl.AutoSizeDelayedHandle(): Boolean; constref;', @TControl_AutoSizeDelayedHandle);
    addGlobalFunc('procedure TControl.SetBounds(aLeft, aTop, aWidth, aHeight: integer); constref;', @TControl_SetBounds);
    addGlobalFunc('procedure TControl.SetInitialBounds(aLeft, aTop, aWidth, aHeight: integer); constref;', @TControl_SetInitialBounds);
    addGlobalFunc('procedure TControl.SetBoundsKeepBase(aLeft, aTop, aWidth, aHeight: integer); constref;', @TControl_SetBoundsKeepBase);
    addGlobalFunc('procedure TControl.GetPreferredSize(var PreferredWidth, PreferredHeight: integer;Raw: boolean;WithThemeSpace: boolean); constref;', @TControl_GetPreferredSize);
    addGlobalFunc('function TControl.GetDefaultWidth(): integer; constref;', @TControl_GetDefaultWidth);
    addGlobalFunc('function TControl.GetDefaultHeight(): integer; constref;', @TControl_GetDefaultHeight);
    addGlobalFunc('function TControl.GetColorResolvingParent(): Integer; constref;', @TControl_GetColorResolvingParent);
    addGlobalFunc('function TControl.GetRGBColorResolvingParent(): Integer; constref;', @TControl_GetRGBColorResolvingParent);
    addGlobalFunc('procedure TControl.InvalidatePreferredSize(); constref;', @TControl_InvalidatePreferredSize);
    addGlobalFunc('procedure TControl.UpdateBaseBounds(StoreBounds, StoreParentClientSize,UseLoadedValues: boolean); constref;', @TControl_UpdateBaseBounds);
    ...
    addGlobalFunc('procedure TControl.ExecuteCancelAction(); constref;', @TControl_ExecuteCancelAction);
    addGlobalFunc('procedure TControl.BringToFront(); constref;', @TControl_BringToFront);
    addGlobalFunc('function TControl.HasParent(): Boolean; constref;', @TControl_HasParent);
    addGlobalFunc('function TControl.GetParentComponent(): TComponent; constref;', @TControl_GetParentComponent);
    addGlobalFunc('function TControl.IsParentOf(AControl: TControl): boolean; constref;', @TControl_IsParentOf);
    addGlobalFunc('function TControl.GetTopParent(): TControl; constref;', @TControl_GetTopParent);
    addGlobalFunc('function TControl.IsVisible(): Boolean; constref;', @TControl_IsVisible);
    addGlobalFunc('function TControl.IsControlVisible(): Boolean; constref;', @TControl_IsControlVisible);
    addGlobalFunc('function TControl.IsEnabled(): Boolean; constref;', @TControl_IsEnabled);
    addGlobalFunc('function TControl.IsParentColor(): Boolean; constref;', @TControl_IsParentColor);
    addGlobalFunc('function TControl.IsParentFont(): Boolean; constref;', @TControl_IsParentFont);
    addGlobalFunc('function TControl.FormIsUpdating(): boolean; constref;', @TControl_FormIsUpdating);
    addGlobalFunc('function TControl.IsProcessingPaintMsg(): boolean; constref;', @TControl_IsProcessingPaintMsg);
    addGlobalFunc('procedure TControl.Hide(); constref;', @TControl_Hide);
    addGlobalFunc('procedure TControl.Refresh(); constref;', @TControl_Refresh);
    addGlobalFunc('procedure TControl.Repaint(); constref;', @TControl_Repaint);
    addGlobalFunc('procedure TControl.Invalidate(); constref;', @TControl_Invalidate);
    addGlobalFunc('procedure TControl.SendToBack(); constref;', @TControl_SendToBack);
    addGlobalFunc('procedure TControl.UpdateRolesForForm(); constref;', @TControl_UpdateRolesForForm);
    addGlobalFunc('procedure TControl.ActiveDefaultControlChanged(NewControl: TControl); constref;', @TControl_ActiveDefaultControlChanged);
    addGlobalFunc('function TControl.GetTextBuf(Buffer: PChar; BufSize: Integer): Integer; constref;', @TControl_GetTextBuf);
    addGlobalFunc('function TControl.GetTextLen(): Integer; constref;', @TControl_GetTextLen);
    addGlobalFunc('procedure TControl.SetTextBuf(Buffer: PChar); constref;', @TControl_SetTextBuf);
    addGlobalFunc('function TControl.ScreenToClient(const APoint: TPoint): TPoint; constref;', @TControl_ScreenToClient);
    addGlobalFunc('function TControl.ClientToScreen(const APoint: TPoint): TPoint; constref;', @TControl_ClientToScreen);
    addGlobalFunc('function TControl.ScreenToControl(const APoint: TPoint): TPoint; constref;', @TControl_ScreenToControl);
    addGlobalFunc('function TControl.ControlToScreen(const APoint: TPoint): TPoint; constref;', @TControl_ControlToScreen);
    addGlobalFunc('function TControl.GetChildsRect(Scrolled: boolean): TRect; constref;', @TControl_GetChildsRect);
    addGlobalFunc('procedure TControl.Show(); constref;', @TControl_Show);
    addGlobalFunc('procedure TControl.Update(); constref;', @TControl_Update);
    addGlobalFunc('function TControl.HandleObjectShouldBeVisible(): boolean; constref;', @TControl_HandleObjectShouldBeVisible);
    addGlobalFunc('function TControl.ParentDestroyingHandle(): boolean; constref;', @TControl_ParentDestroyingHandle);
    addGlobalFunc('function TControl.ParentHandlesAllocated(): boolean; constref;', @TControl_ParentHandlesAllocated);
    addGlobalFunc('procedure TControl.InitiateAction(); constref;', @TControl_InitiateAction);
    ...
    addGlobalFunc('function TControl.UseRightToLeftAlignment(): Boolean; constref;', @TControl_UseRightToLeftAlignment);
    addGlobalFunc('function TControl.UseRightToLeftReading(): Boolean; constref;', @TControl_UseRightToLeftReading);
    addGlobalFunc('function TControl.UseRightToLeftScrollBar(): Boolean; constref;', @TControl_UseRightToLeftScrollBar);
    addGlobalFunc('function TControl.IsRightToLeft(): Boolean; constref;', @TControl_IsRightToLeft);
...
procedure TWinControl_DoubleBuffered_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_ParentWindow_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_ParentWindow_Write(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.ParentWindow := PHandle(Params^[1])^;
end;

//Read: property Showing: Boolean read Showing;
procedure TWinControl_Showing_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.Showing;
end;

//Read: property VisibleDockClientCount: Integer read VisibleDockClientCount;
procedure TWinControl_VisibleDockClientCount_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PWinControl(Params^[0])^.VisibleDockClientCount;
end;

//function AutoSizeDelayed: boolean;
procedure TWinControl_AutoSizeDelayed(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayed();
end;

//function AutoSizeDelayedReport: string;
procedure TWinControl_AutoSizeDelayedReport(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayedReport();
end;

//function AutoSizeDelayedHandle: Boolean;
procedure TWinControl_AutoSizeDelayedHandle(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.AutoSizeDelayedHandle();
end;

//procedure BeginUpdateBounds;
procedure TWinControl_BeginUpdateBounds(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.BeginUpdateBounds();
end;

//procedure EndUpdateBounds;
procedure TWinControl_EndUpdateBounds(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.EndUpdateBounds();
end;

//procedure LockRealizeBounds;
procedure TWinControl_LockRealizeBounds(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.LockRealizeBounds();
end;

//procedure UnlockRealizeBounds;
procedure TWinControl_UnlockRealizeBounds(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.UnlockRealizeBounds();
end;

//function ControlAtPos(const Pos: TPoint; AllowDisabled: Boolean): TControl;
procedure TWinControl_ControlAtPos(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_ControlAtPosEx(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PControl(Result)^ := PWinControl(Params^[0])^.ControlAtPos(PPoint(Params^[1])^, PBoolean(Params^[2])^, PBoolean(Params^[3])^);
end;

//function  ContainsControl(Control: TControl): Boolean;
procedure TWinControl_ContainsControl(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_DoAdjustClientRectChange(const Params: PParamArray);cdecl;
begin
...
procedure TWinControl_InvalidateClientRectCache(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.InvalidateClientRectCache(Pboolean(Params^[1])^);
end;

//function ClientRectNeedsInterfaceUpdate: boolean;
procedure TWinControl_ClientRectNeedsInterfaceUpdate(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.ClientRectNeedsInterfaceUpdate();
end;

//procedure SetBounds(ALeft, ATop, AWidth, AHeight: integer);
procedure TWinControl_SetBounds(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.SetBounds(Pinteger(Params^[1])^, Pinteger(Params^[2])^, Pinteger(Params^[3])^, Pinteger(Params^[4])^);
end;

//function  GetChildsRect(Scrolled: boolean): TRect;
procedure TWinControl_GetChildsRect(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PRect(Result)^ := PWinControl(Params^[0])^.GetChildrenRect(Pboolean(Params^[1])^);
end;

//procedure DisableAlign;
procedure TWinControl_DisableAlign(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.DisableAlign();
end;

//procedure EnableAlign;
procedure TWinControl_EnableAlign(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.EnableAlign();
end;

//procedure ReAlign;
procedure TWinControl_ReAlign(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.ReAlign();
end;

//procedure ScrollBy(DeltaX, DeltaY: Integer);
procedure TWinControl_ScrollBy(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.ScrollBy(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//procedure WriteLayoutDebugReport(const Prefix: string);
procedure TWinControl_WriteLayoutDebugReport(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.WriteLayoutDebugReport(PlpString(Params^[1])^);
end;

//constructor Create(TheOwner: TComponent);
procedure TWinControl_Init(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^ := TWinControl.Create(PComponent(Params^[1])^);
end;

//constructor CreateParented(AParentWindow: Thandle);
procedure TWinControl_CreateParented(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^ := TWinControl.CreateParented(Phandle(Params^[1])^);
end;

//function CanFocus: Boolean;
procedure TWinControl_CanFocus(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.CanFocus();
end;

//function GetControlIndex(AControl: TControl): integer;
procedure TWinControl_GetControlIndex(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_SetControlIndex(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.SetControlIndex(PControl(Params^[1])^, Pinteger(Params^[2])^);
end;

//function Focused: Boolean;
procedure TWinControl_Focused(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.Focused();
end;

//function PerformTab(ForwardTab: boolean): boolean;
procedure TWinControl_PerformTab(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.PerformTab(Pboolean(Params^[1])^);
end;

//function FindChildControl(const ControlName: String): TControl;
procedure TWinControl_FindChildControl(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TWinControl_SelectNext(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.SelectNext(PWinControl(Params^[1])^, PBoolean(Params^[2])^, PBoolean(Params^[3])^);
end;

//function  GetTextLen: Integer;
procedure TWinControl_GetTextLen(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PWinControl(Params^[0])^.GetTextLen();
end;

//procedure Invalidate;
procedure TWinControl_Invalidate(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.Invalidate();
end;

//procedure AddControl;
procedure TWinControl_AddControl(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.AddControl();
end;

//procedure InsertControl(AControl: TControl);
procedure TWinControl_InsertControl(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.InsertControl(PControl(Params^[1])^);
end;

//procedure InsertControl(AControl: TControl; Index: integer);
procedure TWinControl_InsertControlEx(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.InsertControl(PControl(Params^[1])^, Pinteger(Params^[2])^);
end;

//procedure RemoveControl(AControl: TControl);
procedure TWinControl_RemoveControl(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.RemoveControl(PControl(Params^[1])^);
end;

//procedure Repaint;
procedure TWinControl_Repaint(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.Repaint();
end;

//procedure Update;
procedure TWinControl_Update(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.Update();
end;

//procedure SetFocus;
procedure TWinControl_SetFocus(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.SetFocus();
end;

//procedure FlipChildren(AllLevels: Boolean);
procedure TWinControl_FlipChildren(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.FlipChildren(PBoolean(Params^[1])^);
end;

//procedure ScaleBy(Multiplier, Divider: Integer);
procedure TWinControl_ScaleBy(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.ScaleBy(PInteger(Params^[1])^, PInteger(Params^[2])^);
end;

//function GetDockCaption(AControl: TControl): String;
procedure TWinControl_GetDockCaption(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PlpString(Result)^ := PWinControl(Params^[0])^.GetDockCaption(PControl(Params^[1])^);
end;

//procedure UpdateDockCaption(Exclude: TControl);
procedure TWinControl_UpdateDockCaption(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.UpdateDockCaption(PControl(Params^[1])^);
end;

//function HandleAllocated: Boolean;
procedure TWinControl_HandleAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.HandleAllocated();
end;

//function ParentHandlesAllocated: boolean;
procedure TWinControl_ParentHandlesAllocated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pboolean(Result)^ := PWinControl(Params^[0])^.ParentHandlesAllocated();
end;

//procedure HandleNeeded;
procedure TWinControl_HandleNeeded(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.HandleNeeded();
end;

//function BrushCreated: Boolean;
procedure TWinControl_BrushCreated(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PWinControl(Params^[0])^.BrushCreated();
end;

//procedure PaintTo(ACanvas: TCanvas; X, Y: Integer);
procedure TWinControl_PaintTo(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.PaintTo(PCanvas(Params^[1])^, PInteger(Params^[2])^, PInteger(Params^[3])^);
end;

//procedure SetShape(AShape: TBitmap);
procedure TWinControl_SetShape(const Params: PParamArray);cdecl;
begin
  PWinControl(Params^[0])^.SetShape(PBitmap(Params^[1])^);
end;

//procedure Free();
procedure TWinControl_Free(const Params: PParamArray);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('procedure TWinControl.UnlockRealizeBounds(); constref;', @TWinControl_UnlockRealizeBounds);
    addGlobalFunc('function TWinControl.ControlAtPos(const Pos: TPoint; AllowDisabled: Boolean): TControl; constref;', @TWinControl_ControlAtPos);
    addGlobalFunc('function TWinControl.ControlAtPos(const Pos: TPoint;AllowDisabled, AllowWinControls: Boolean): TControl; constref; overload;', @TWinControl_ControlAtPosEx);
    addGlobalFunc('function TWinControl.ContainsControl(Control: TControl): Boolean; constref;', @TWinControl_ContainsControl);
    ...
    addGlobalFunc('procedure TWinControl.SetControlIndex(AControl: TControl; NewIndex: integer); constref;', @TWinControl_SetControlIndex);
    addGlobalFunc('function TWinControl.Focused(): Boolean; constref;', @TWinControl_Focused);
...
procedure TControlScrollBar_Init(const Params: PParamArray);cdecl;
begin
  PControlScrollBar(Params^[0])^ := TControlScrollBar.Create(PWinControl(Params^[1])^, PScrollBarKind(Params^[2])^);
end;

//procedure Assign(Source: TPersistent);
procedure TControlScrollBar_Assign(const Params: PParamArray);cdecl;
begin
  PControlScrollBar(Params^[0])^.Assign(PPersistent(Params^[1])^);
end;

//function IsScrollBarVisible: Boolean;
procedure TControlScrollBar_IsScrollBarVisible(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PBoolean(Result)^ := PControlScrollBar(Params^[0])^.IsScrollBarVisible();
end;

//function ScrollPos: Integer;
procedure TControlScrollBar_ScrollPos(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PInteger(Result)^ := PControlScrollBar(Params^[0])^.ScrollPos();
end;

//function GetOtherScrollBar: TControlScrollBar;
procedure TControlScrollBar_GetOtherScrollBar(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PControlScrollBar(Result)^ := PControlScrollBar(Params^[0])^.GetOtherScrollBar();
end;

//Read: property Size: integer read Size;
procedure TControlScrollBar_Size_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.Size;
end;

//function ClientSize: integer;
procedure TControlScrollBar_ClientSize(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.ClientSize();
end;

//function ClientSizeWithBar: integer;
procedure TControlScrollBar_ClientSizeWithBar(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  Pinteger(Result)^ := PControlScrollBar(Params^[0])^.ClientSizeWithBar();
end;

//function ClientSizeWithoutBar: integer;
procedure TControlScrollBar_ClientSizeWithoutBar(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TControlScrollBar.ClientSize(): integer; constref;', @TControlScrollBar_ClientSize);
    addGlobalFunc('function TControlScrollBar.ClientSizeWithBar(): integer; constref;', @TControlScrollBar_ClientSizeWithBar);
    addGlobalFunc('function TControlScrollBar.ClientSizeWithoutBar(): integer; constref;', @TControlScrollBar_ClientSizeWithoutBar);
...
//constructor Create(TheOwner : TComponent);
procedure TScrollingWinControl_Init(const Params: PParamArray);cdecl;
begin
  PScrollingWinControl(Params^[0])^ := TScrollingWinControl.Create(PComponent(Params^[1])^);
end;

//procedure UpdateScrollbars;
procedure TScrollingWinControl_UpdateScrollbars(const Params: PParamArray);cdecl;
begin
  PScrollingWinControl(Params^[0])^.UpdateScrollbars();
end;

//procedure ScrollBy(DeltaX, DeltaY: Integer);
procedure TScrollingWinControl_ScrollBy(const Params: PParamArray);cdecl;
begin
...
procedure TScrollingWinControl_HorzScrollBar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TScrollingWinControl_HorzScrollBar_Write(const Params: PParamArray);cdecl;
begin
...
procedure TScrollingWinControl_VertScrollBar_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
...
procedure TScrollingWinControl_VertScrollBar_Write(const Params: PParamArray);cdecl;
begin
  PScrollingWinControl(Params^[0])^.VertScrollBar := PControlScrollBar(Params^[1])^;
end;

//procedure Free();
procedure TScrollingWinControl_Free(const Params: PParamArray);cdecl;
begin
...
procedure TGraphicControl_Canvas_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PCanvas(Result)^ := PGraphicControl(Params^[0])^.Canvas;
end;

//procedure Update();
procedure TGraphicControl_Update(const Params: PParamArray);cdecl;
begin
  PGraphicControl(Params^[0])^.Update();
end;

procedure TGraphicControl_Align_Read(const Params: PParamArray; const Result: Pointer);cdecl;
begin
  PAlign(Result)^ := PGraphicControl(Params^[0])^.Align;
end;

procedure TGraphicControl_Align_Write(const Params: PParamArray);cdecl;
begin
